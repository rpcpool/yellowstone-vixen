...
pub const ADD_OPERATOR_DISCRIMINATOR: [u8; 8] = [149, 142, 187, 68, 33, 250, 87, 105];
...
impl AddOperator {
  pub fn instruction(&self, args: AddOperatorInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddOperatorInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&AddOperatorInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct AddOperatorInstructionData {
            discriminator: [u8; 8],
            }

impl AddOperatorInstructionData {
  pub fn new() -> Self {
    Self {
...
impl Default for AddOperatorInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct AddOperatorInstructionArgs {
                  pub operator: Pubkey,
      }


/// Instruction builder for `AddOperator`.
///
/// ### Accounts:
///
...
impl AddOperatorBuilder {
  ...
  /// `add_operator` CPI accounts.
  pub struct AddOperatorCpiAccounts<'a, 'b> {
...
/// `add_operator` CPI instruction.
pub struct AddOperatorCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: AddOperatorInstructionArgs,
  }

impl<'a, 'b> AddOperatorCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: AddOperatorCpiAccounts<'a, 'b>,
              args: AddOperatorInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `AddOperator` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` authorized_programs
                ///   1. `[signer]` admin
#[derive(Clone, Debug)]
pub struct AddOperatorCpiBuilder<'a, 'b> {
  instruction: Box<AddOperatorCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddOperatorCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(AddOperatorCpiBuilderInstruction {
      __program: program,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        let instruction = AddOperatorCpi {
...
#[derive(Clone, Debug)]
struct AddOperatorCpiBuilderInstruction<'a, 'b> {
