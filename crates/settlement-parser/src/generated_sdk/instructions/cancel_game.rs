...
pub const CANCEL_GAME_DISCRIMINATOR: [u8; 8] = [121, 194, 154, 118, 103, 235, 149, 52];
...
pub struct CancelGame {
          ...
          pub game_registry: solana_pubkey::Pubkey,
                /// Generic game program for cancellation

    
              
          pub game_program: solana_pubkey::Pubkey,
                /// Generic game account for cancellation
          ...
          pub operator: solana_pubkey::Pubkey,
                /// Game keeper program (optional, for cleanup)

    
              
          pub game_keeper_program: Option<solana_pubkey::Pubkey>,
                /// Game randomness account (optional, for cleanup)

    
              
          pub game_randomness: Option<solana_pubkey::Pubkey>,
...
impl CancelGame {
  pub fn instruction(&self, args: CancelGameInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CancelGameInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    let mut accounts = Vec::with_capacity(14+ remaining_accounts.len());
            ...
            true
                                                      ...
                                                      if let Some(game_keeper_program) = self.game_keeper_program {
              accounts.push(solana_instruction::AccountMeta::new_readonly(
                game_keeper_program,
                false,
              ));
              ...
              accounts.push(solana_instruction::AccountMeta::new_readonly(
                ...
                false,
                                                                ...
                                                                if let Some(game_randomness) = self.game_randomness {
              accounts.push(solana_instruction::AccountMeta::new(
                game_randomness,
                false,
              ));
    ...
    let mut data = borsh::to_vec(&CancelGameInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CancelGameInstructionData {
            discriminator: [u8; 8],
            }

impl CancelGameInstructionData {
  pub fn new() -> Self {
    Self {
...
impl Default for CancelGameInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CancelGameInstructionArgs {
                  pub game_id: u64,
      }


/// Instruction builder for `CancelGame`.
///
/// ### Accounts:
///
          ...
          ///   3. `[]` global_config
                ///   4. `[writable]` settlement_authority
                      ///   5. `[writable, signer]` operator
                ///   6. `[optional]` game_keeper_program
                      ///   7. `[writable, optional]` game_randomness
          ///   8. `[]` authorized_programs
          ///   9. `[]` rando_program
                ///   10. `[writable]` randomness_state
                ///   11. `[optional]` instruction_sysvar (default to `Sysvar1nstructions1111111111111111111111111`)
                ///   12. `[optional]` slot_hashes (default to `SysvarS1otHashes111111111111111111111111111`)
                ///   13. `[optional]` system_program (default to `11111111111111111111111111111111`)
#[derive(Clone, Debug, Default)]
pub struct CancelGameBuilder {
...
/// Game keeper program (optional, for cleanup)
#[inline(always)]
    pub fn game_keeper_program(&mut self, game_keeper_program: Option<solana_pubkey::Pubkey>) -> &mut Self {
                        self.game_keeper_program = game_keeper_program;
                    self
    }
            /// `[optional account]`
/// Game randomness account (optional, for cleanup)
#[inline(always)]
    pub fn game_randomness(&mut self, game_randomness: Option<solana_pubkey::Pubkey>) -> &mut Self {
                        self.game_randomness = game_randomness;
                    self
    }
            /// Authorized programs account for validation
#[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = CancelGame {
                              game_registry: self.game_registry.expect("game_registry is not set"),
                                        ...
                                        game_keeper_program: self.game_keeper_program,
                                        game_randomness: self.game_randomness,
          ...
          let args = CancelGameInstructionArgs {
  ...
  /// `cancel_game` CPI accounts.
  pub struct CancelGameCpiAccounts<'a, 'b> {
              ...
              pub game_keeper_program: Option<&'b solana_account_info::AccountInfo<'a>>,
                        /// Game randomness account (optional, for cleanup)

      
                    
              pub game_randomness: Option<&'b solana_account_info::AccountInfo<'a>>,
                        /// Authorized programs account for validation
...
/// `cancel_game` CPI instruction.
pub struct CancelGameCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: CancelGameInstructionArgs,
  }

impl<'a, 'b> CancelGameCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: CancelGameCpiAccounts<'a, 'b>,
              args: CancelGameInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
  ...
  pub fn invoke_signed_with_remaining_accounts(
    ...
    account_infos.push(self.__program.clone());
                  account_infos.push(self.game_registry.clone());
                        ...
                        if let Some(game_keeper_program) = self.game_keeper_program {
          account_infos.push(game_keeper_program.clone());
        }
                        if let Some(game_randomness) = self.game_randomness {
          account_infos.push(game_randomness.clone());
        }
...
/// Instruction builder for `CancelGame` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` game_registry
          ...
          ///   13. `[]` system_program
#[derive(Clone, Debug)]
pub struct CancelGameCpiBuilder<'a, 'b> {
  instruction: Box<CancelGameCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CancelGameCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(CancelGameCpiBuilderInstruction {
      __program: program,
              game_registry: None,
              game_program: None,
              game_account: None,
...
/// Game keeper program (optional, for cleanup)
#[inline(always)]
    pub fn game_keeper_program(&mut self, game_keeper_program: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
                        self.instruction.game_keeper_program = game_keeper_program;
                    self
    }
      /// `[optional account]`
/// Game randomness account (optional, for cleanup)
#[inline(always)]
    pub fn game_randomness(&mut self, game_randomness: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
                        self.instruction.game_randomness = game_randomness;
                    self
    }
      /// Authorized programs account for validation
#[inline(always)]
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          game_keeper_program: self.instruction.game_keeper_program,
                  
          game_randomness: self.instruction.game_randomness,
...
#[derive(Clone, Debug)]
struct CancelGameCpiBuilderInstruction<'a, 'b> {
