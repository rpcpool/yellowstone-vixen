...
pub const SETTLE_GAME_INTERNAL_DISCRIMINATOR: [u8; 8] = [18, 52, 86, 120, 154, 188, 222, 244];

/// Accounts.
#[derive(Debug)]
pub struct SettleGameInternal {
...
impl SettleGameInternal {
  pub fn instruction(&self, args: SettleGameInternalInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SettleGameInternalInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&SettleGameInternalInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SettleGameInternalInstructionData {
            discriminator: [u8; 8],
            }

impl SettleGameInternalInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [18, 52, 86, 120, 154, 188, 222, 244],
                                }
  }
}

impl Default for SettleGameInternalInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SettleGameInternalInstructionArgs {
                  pub final_randomness: [u8; 32],
      }


/// Instruction builder for `SettleGameInternal`.
///
/// ### Accounts:
///
                ///   0. `[writable]` game
...
pub struct SettleGameInternalBuilder {
...
impl SettleGameInternalBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SettleGameInternal {
          ...
          let args = SettleGameInternalInstructionArgs {
  ...
  /// `settle_game_internal` CPI accounts.
  pub struct SettleGameInternalCpiAccounts<'a, 'b> {
...
/// `settle_game_internal` CPI instruction.
pub struct SettleGameInternalCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: SettleGameInternalInstructionArgs,
  }

impl<'a, 'b> SettleGameInternalCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: SettleGameInternalCpiAccounts<'a, 'b>,
              args: SettleGameInternalInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
              game: accounts.game,
...
/// Instruction builder for `SettleGameInternal` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` game
          ...
          ///   4. `[]` system_program
#[derive(Clone, Debug)]
pub struct SettleGameInternalCpiBuilder<'a, 'b> {
  instruction: Box<SettleGameInternalCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SettleGameInternalCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SettleGameInternalCpiBuilderInstruction {
      __program: program,
              game: None,
              global_config: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        let instruction = SettleGameInternalCpi {
...
#[derive(Clone, Debug)]
struct SettleGameInternalCpiBuilderInstruction<'a, 'b> {
