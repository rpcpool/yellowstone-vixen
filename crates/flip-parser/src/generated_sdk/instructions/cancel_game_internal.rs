...
pub const CANCEL_GAME_INTERNAL_DISCRIMINATOR: [u8; 8] = [18, 52, 86, 120, 154, 188, 222, 245];

/// Accounts.
#[derive(Debug)]
pub struct CancelGameInternal {
...
impl CancelGameInternal {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = borsh::to_vec(&CancelGameInternalInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CancelGameInternalInstructionData {
            discriminator: [u8; 8],
      }

impl CancelGameInternalInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [18, 52, 86, 120, 154, 188, 222, 245],
                  }
  }
}

impl Default for CancelGameInternalInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `CancelGameInternal`.
///
/// ### Accounts:
///
                ///   0. `[writable]` game
...
pub struct CancelGameInternalBuilder {
...
impl CancelGameInternalBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = CancelGameInternal {
  ...
  /// `cancel_game_internal` CPI accounts.
  pub struct CancelGameInternalCpiAccounts<'a, 'b> {
...
/// `cancel_game_internal` CPI instruction.
pub struct CancelGameInternalCpi<'a, 'b> {
...
impl<'a, 'b> CancelGameInternalCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: CancelGameInternalCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
              game: accounts.game,
...
/// Instruction builder for `CancelGameInternal` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` game
          ...
          ///   4. `[]` system_program
#[derive(Clone, Debug)]
pub struct CancelGameInternalCpiBuilder<'a, 'b> {
  instruction: Box<CancelGameInternalCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CancelGameInternalCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(CancelGameInternalCpiBuilderInstruction {
      __program: program,
              game: None,
              global_config: None,
...
#[inline(always)]
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        let instruction = CancelGameInternalCpi {
...
#[derive(Clone, Debug)]
struct CancelGameInternalCpiBuilderInstruction<'a, 'b> {
