...
pub const CANCEL_BET_INTERNAL_DISCRIMINATOR: [u8; 8] = [18, 52, 86, 120, 154, 188, 222, 243];

/// Accounts.
#[derive(Debug)]
pub struct CancelBetInternal {
...
impl CancelBetInternal {
  pub fn instruction(&self, args: CancelBetInternalInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CancelBetInternalInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&CancelBetInternalInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CancelBetInternalInstructionData {
            discriminator: [u8; 8],
                  }

impl CancelBetInternalInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [18, 52, 86, 120, 154, 188, 222, 243],
                                              }
  }
}

impl Default for CancelBetInternalInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CancelBetInternalInstructionArgs {
                  pub bet_id: u64,
                pub player: Pubkey,
      }


/// Instruction builder for `CancelBetInternal`.
///
/// ### Accounts:
///
                ///   0. `[writable]` game
...
pub struct CancelBetInternalBuilder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = CancelBetInternal {
          ...
          let args = CancelBetInternalInstructionArgs {
  ...
  /// `cancel_bet_internal` CPI accounts.
  pub struct CancelBetInternalCpiAccounts<'a, 'b> {
...
/// `cancel_bet_internal` CPI instruction.
pub struct CancelBetInternalCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: CancelBetInternalInstructionArgs,
  }

impl<'a, 'b> CancelBetInternalCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: CancelBetInternalCpiAccounts<'a, 'b>,
              args: CancelBetInternalInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
              game: accounts.game,
...
/// Instruction builder for `CancelBetInternal` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` game
          ...
          ///   4. `[]` system_program
#[derive(Clone, Debug)]
pub struct CancelBetInternalCpiBuilder<'a, 'b> {
  instruction: Box<CancelBetInternalCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CancelBetInternalCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(CancelBetInternalCpiBuilderInstruction {
      __program: program,
              game: None,
              global_config: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        let instruction = CancelBetInternalCpi {
...
#[derive(Clone, Debug)]
struct CancelBetInternalCpiBuilderInstruction<'a, 'b> {
