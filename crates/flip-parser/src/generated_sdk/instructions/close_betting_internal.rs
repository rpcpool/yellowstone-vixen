...
pub const CLOSE_BETTING_INTERNAL_DISCRIMINATOR: [u8; 8] = [18, 52, 86, 120, 154, 188, 222, 246];

/// Accounts.
#[derive(Debug)]
pub struct CloseBettingInternal {
...
impl CloseBettingInternal {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = borsh::to_vec(&CloseBettingInternalInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CloseBettingInternalInstructionData {
            discriminator: [u8; 8],
      }

impl CloseBettingInternalInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [18, 52, 86, 120, 154, 188, 222, 246],
                  }
  }
}

impl Default for CloseBettingInternalInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `CloseBettingInternal`.
///
/// ### Accounts:
///
                ///   0. `[writable]` game
...
pub struct CloseBettingInternalBuilder {
...
impl CloseBettingInternalBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = CloseBettingInternal {
  ...
  /// `close_betting_internal` CPI accounts.
  pub struct CloseBettingInternalCpiAccounts<'a, 'b> {
...
/// `close_betting_internal` CPI instruction.
pub struct CloseBettingInternalCpi<'a, 'b> {
...
impl<'a, 'b> CloseBettingInternalCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: CloseBettingInternalCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
              game: accounts.game,
...
/// Instruction builder for `CloseBettingInternal` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` game
          ...
          ///   4. `[]` system_program
#[derive(Clone, Debug)]
pub struct CloseBettingInternalCpiBuilder<'a, 'b> {
  instruction: Box<CloseBettingInternalCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CloseBettingInternalCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(CloseBettingInternalCpiBuilderInstruction {
      __program: program,
              game: None,
              global_config: None,
...
#[inline(always)]
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        let instruction = CloseBettingInternalCpi {
...
#[derive(Clone, Debug)]
struct CloseBettingInternalCpiBuilderInstruction<'a, 'b> {
