...
pub const ACTIVATE_GAME_INTERNAL_DISCRIMINATOR: [u8; 8] = [18, 52, 86, 120, 154, 188, 222, 241];

/// Accounts.
#[derive(Debug)]
pub struct ActivateGameInternal {
...
impl ActivateGameInternal {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = borsh::to_vec(&ActivateGameInternalInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ActivateGameInternalInstructionData {
            discriminator: [u8; 8],
      }

impl ActivateGameInternalInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [18, 52, 86, 120, 154, 188, 222, 241],
                  }
  }
}

impl Default for ActivateGameInternalInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `ActivateGameInternal`.
///
/// ### Accounts:
///
                ///   0. `[writable]` game
...
pub struct ActivateGameInternalBuilder {
...
impl ActivateGameInternalBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = ActivateGameInternal {
  ...
  /// `activate_game_internal` CPI accounts.
  pub struct ActivateGameInternalCpiAccounts<'a, 'b> {
...
/// `activate_game_internal` CPI instruction.
pub struct ActivateGameInternalCpi<'a, 'b> {
...
impl<'a, 'b> ActivateGameInternalCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: ActivateGameInternalCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
              game: accounts.game,
...
/// Instruction builder for `ActivateGameInternal` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` game
          ...
          ///   4. `[]` system_program
#[derive(Clone, Debug)]
pub struct ActivateGameInternalCpiBuilder<'a, 'b> {
  instruction: Box<ActivateGameInternalCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ActivateGameInternalCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(ActivateGameInternalCpiBuilderInstruction {
      __program: program,
              game: None,
              global_config: None,
...
#[inline(always)]
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        let instruction = ActivateGameInternalCpi {
...
#[derive(Clone, Debug)]
struct ActivateGameInternalCpiBuilderInstruction<'a, 'b> {
