...
impl UpdateOracleBackupFeed {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&UpdateOracleBackupFeedInstructionData::new()).unwrap();
...
pub struct UpdateOracleBackupFeedInstructionData {
    discriminator: [u8; 8],
}

impl UpdateOracleBackupFeedInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [230, 9, 33, 202, 228, 209, 180, 98],
        }
    }
}

impl Default for UpdateOracleBackupFeedInstructionData {
    fn default() -> Self { Self::new() }
}

/// Instruction builder for `UpdateOracleBackupFeed`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct UpdateOracleBackupFeedBuilder {
...
impl UpdateOracleBackupFeedBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = UpdateOracleBackupFeed {
...
/// `update_oracle_backup_feed` CPI accounts.
pub struct UpdateOracleBackupFeedCpiAccounts<'a, 'b> {
...
/// `update_oracle_backup_feed` CPI instruction.
pub struct UpdateOracleBackupFeedCpi<'a, 'b> {
...
impl<'a, 'b> UpdateOracleBackupFeedCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UpdateOracleBackupFeedCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `UpdateOracleBackupFeed` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   3. `[]` oracle
#[derive(Clone, Debug)]
pub struct UpdateOracleBackupFeedCpiBuilder<'a, 'b> {
    instruction: Box<UpdateOracleBackupFeedCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdateOracleBackupFeedCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdateOracleBackupFeedCpiBuilderInstruction {
            __program: program,
            state: None,
            zeta_group: None,
            admin: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = UpdateOracleBackupFeedCpi {
...
#[derive(Clone, Debug)]
struct UpdateOracleBackupFeedCpiBuilderInstruction<'a, 'b> {
