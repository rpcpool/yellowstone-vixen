...
impl CancelOrderByClientOrderIdNoError {
    pub fn instruction(
        &self,
        args: CancelOrderByClientOrderIdNoErrorInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data =
            borsh::to_vec(&CancelOrderByClientOrderIdNoErrorInstructionData::new()).unwrap();
...
pub struct CancelOrderByClientOrderIdNoErrorInstructionData {
    discriminator: [u8; 8],
}

impl CancelOrderByClientOrderIdNoErrorInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [53, 77, 167, 157, 175, 131, 144, 171],
        }
    }
}

impl Default for CancelOrderByClientOrderIdNoErrorInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CancelOrderByClientOrderIdNoErrorInstructionArgs {
    pub client_order_id: u64,
    pub asset: Asset,
}

/// Instruction builder for `CancelOrderByClientOrderIdNoError`.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
pub struct CancelOrderByClientOrderIdNoErrorBuilder {
...
impl CancelOrderByClientOrderIdNoErrorBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CancelOrderByClientOrderIdNoError {
        ...
        let args = CancelOrderByClientOrderIdNoErrorInstructionArgs {
...
/// `cancel_order_by_client_order_id_no_error` CPI accounts.
pub struct CancelOrderByClientOrderIdNoErrorCpiAccounts<'a, 'b> {
...
/// `cancel_order_by_client_order_id_no_error` CPI instruction.
pub struct CancelOrderByClientOrderIdNoErrorCpi<'a, 'b> {
    ...
    pub __args: CancelOrderByClientOrderIdNoErrorInstructionArgs,
}

impl<'a, 'b> CancelOrderByClientOrderIdNoErrorCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CancelOrderByClientOrderIdNoErrorCpiAccounts<'a, 'b>,
        args: CancelOrderByClientOrderIdNoErrorInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CancelOrderByClientOrderIdNoError` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
///   9. `[writable]` event_queue
#[derive(Clone, Debug)]
pub struct CancelOrderByClientOrderIdNoErrorCpiBuilder<'a, 'b> {
    instruction: Box<CancelOrderByClientOrderIdNoErrorCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CancelOrderByClientOrderIdNoErrorCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CancelOrderByClientOrderIdNoErrorCpiBuilderInstruction {
            __program: program,
            authority: None,
            state: None,
            margin_account: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = CancelOrderByClientOrderIdNoErrorCpi {
...
#[derive(Clone, Debug)]
struct CancelOrderByClientOrderIdNoErrorCpiBuilderInstruction<'a, 'b> {
