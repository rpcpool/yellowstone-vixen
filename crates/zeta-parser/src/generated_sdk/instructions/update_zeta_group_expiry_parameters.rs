...
impl UpdateZetaGroupExpiryParameters {
    pub fn instruction(
        &self,
        args: UpdateZetaGroupExpiryParametersInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data =
            borsh::to_vec(&UpdateZetaGroupExpiryParametersInstructionData::new()).unwrap();
...
pub struct UpdateZetaGroupExpiryParametersInstructionData {
    discriminator: [u8; 8],
}

impl UpdateZetaGroupExpiryParametersInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [17, 69, 121, 104, 225, 206, 140, 215],
        }
    }
}

impl Default for UpdateZetaGroupExpiryParametersInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct UpdateZetaGroupExpiryParametersInstructionArgs {
    pub expiry_interval_seconds: u32,
    pub new_expiry_threshold_seconds: u32,
}

/// Instruction builder for `UpdateZetaGroupExpiryParameters`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct UpdateZetaGroupExpiryParametersBuilder {
...
impl UpdateZetaGroupExpiryParametersBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = UpdateZetaGroupExpiryParameters {
            state: self.state.expect("state is not set"),
            zeta_group: self.zeta_group.expect("zeta_group is not set"),
            admin: self.admin.expect("admin is not set"),
        };
        let args = UpdateZetaGroupExpiryParametersInstructionArgs {
...
/// `update_zeta_group_expiry_parameters` CPI accounts.
pub struct UpdateZetaGroupExpiryParametersCpiAccounts<'a, 'b> {
...
/// `update_zeta_group_expiry_parameters` CPI instruction.
pub struct UpdateZetaGroupExpiryParametersCpi<'a, 'b> {
    ...
    pub __args: UpdateZetaGroupExpiryParametersInstructionArgs,
}

impl<'a, 'b> UpdateZetaGroupExpiryParametersCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UpdateZetaGroupExpiryParametersCpiAccounts<'a, 'b>,
        args: UpdateZetaGroupExpiryParametersInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `UpdateZetaGroupExpiryParameters` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   2. `[signer]` admin
#[derive(Clone, Debug)]
pub struct UpdateZetaGroupExpiryParametersCpiBuilder<'a, 'b> {
    instruction: Box<UpdateZetaGroupExpiryParametersCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdateZetaGroupExpiryParametersCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdateZetaGroupExpiryParametersCpiBuilderInstruction {
            __program: program,
            state: None,
            zeta_group: None,
            admin: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = UpdateZetaGroupExpiryParametersCpi {
...
#[derive(Clone, Debug)]
struct UpdateZetaGroupExpiryParametersCpiBuilderInstruction<'a, 'b> {
