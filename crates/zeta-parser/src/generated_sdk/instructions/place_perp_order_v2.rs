...
use crate::generated::types::{OrderType, Side};
...
impl PlacePerpOrderV2 {
    pub fn instruction(
        &self,
        args: PlacePerpOrderV2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&PlacePerpOrderV2InstructionData::new()).unwrap();
...
pub struct PlacePerpOrderV2InstructionData {
    discriminator: [u8; 8],
}

impl PlacePerpOrderV2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [205, 84, 130, 180, 63, 118, 10, 207],
        }
    }
}

impl Default for PlacePerpOrderV2InstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct PlacePerpOrderV2InstructionArgs {
    pub price: u64,
    pub size: u64,
    pub side: Side,
...
/// Instruction builder for `PlacePerpOrderV2`.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   6. `[]` serum_authority
///   7. `[]` greeks
///   8. `[writable]` open_orders
///   9. `[optional]` rent (default to `SysvarRent111111111111111111111111111111111`)
///   10. `[writable]` market
///   11. `[writable]` request_queue
///   12. `[writable]` event_queue
///   13. `[writable]` bids
///   14. `[writable]` asks
///   15. `[writable]` order_payer_token_account
///   16. `[writable]` coin_vault
///   17. `[writable]` pc_vault
///   18. `[writable]` coin_wallet
///   19. `[writable]` pc_wallet
///   20. `[]` oracle
///   21. `[]` oracle_backup_feed
///   22. `[]` oracle_backup_program
///   23. `[writable]` market_mint
///   24. `[]` mint_authority
///   25. `[writable]` perp_sync_queue
#[derive(Clone, Debug, Default)]
pub struct PlacePerpOrderV2Builder {
...
impl PlacePerpOrderV2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = PlacePerpOrderV2InstructionArgs {
...
/// `place_perp_order_v2` CPI accounts.
pub struct PlacePerpOrderV2CpiAccounts<'a, 'b> {
...
/// `place_perp_order_v2` CPI instruction.
pub struct PlacePerpOrderV2Cpi<'a, 'b> {
    ...
    pub __args: PlacePerpOrderV2InstructionArgs,
}

impl<'a, 'b> PlacePerpOrderV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: PlacePerpOrderV2CpiAccounts<'a, 'b>,
        args: PlacePerpOrderV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `PlacePerpOrderV2` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   25. `[writable]` perp_sync_queue
#[derive(Clone, Debug)]
pub struct PlacePerpOrderV2CpiBuilder<'a, 'b> {
    instruction: Box<PlacePerpOrderV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PlacePerpOrderV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(PlacePerpOrderV2CpiBuilderInstruction {
            __program: program,
            state: None,
            zeta_group: None,
            margin_account: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = PlacePerpOrderV2Cpi {
...
#[derive(Clone, Debug)]
struct PlacePerpOrderV2CpiBuilderInstruction<'a, 'b> {
