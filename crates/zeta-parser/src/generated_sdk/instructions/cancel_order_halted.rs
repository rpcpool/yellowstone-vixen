...
impl CancelOrderHalted {
    pub fn instruction(
        &self,
        args: CancelOrderHaltedInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&CancelOrderHaltedInstructionData::new()).unwrap();
...
pub struct CancelOrderHaltedInstructionData {
    discriminator: [u8; 8],
}

impl CancelOrderHaltedInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [0, 192, 233, 2, 252, 251, 130, 169],
        }
    }
}

impl Default for CancelOrderHaltedInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CancelOrderHaltedInstructionArgs {
    pub side: Side,
    pub order_id: u128,
    pub asset: Asset,
}

/// Instruction builder for `CancelOrderHalted`.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   6. `[writable]` bids
///   7. `[writable]` asks
///   8. `[writable]` event_queue
#[derive(Clone, Debug, Default)]
pub struct CancelOrderHaltedBuilder {
...
impl CancelOrderHaltedBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CancelOrderHalted {
        ...
        let args = CancelOrderHaltedInstructionArgs {
...
/// `cancel_order_halted` CPI accounts.
pub struct CancelOrderHaltedCpiAccounts<'a, 'b> {
...
/// `cancel_order_halted` CPI instruction.
pub struct CancelOrderHaltedCpi<'a, 'b> {
    ...
    pub __args: CancelOrderHaltedInstructionArgs,
}

impl<'a, 'b> CancelOrderHaltedCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CancelOrderHaltedCpiAccounts<'a, 'b>,
        args: CancelOrderHaltedInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CancelOrderHalted` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   8. `[writable]` event_queue
#[derive(Clone, Debug)]
pub struct CancelOrderHaltedCpiBuilder<'a, 'b> {
    instruction: Box<CancelOrderHaltedCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CancelOrderHaltedCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CancelOrderHaltedCpiBuilderInstruction {
            __program: program,
            state: None,
            margin_account: None,
            dex_program: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = CancelOrderHaltedCpi {
...
#[derive(Clone, Debug)]
struct CancelOrderHaltedCpiBuilderInstruction<'a, 'b> {
