...
impl WithdrawInsuranceVaultV2 {
    pub fn instruction(
        &self,
        args: WithdrawInsuranceVaultV2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&WithdrawInsuranceVaultV2InstructionData::new()).unwrap();
...
pub struct WithdrawInsuranceVaultV2InstructionData {
    discriminator: [u8; 8],
}

impl WithdrawInsuranceVaultV2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [203, 71, 44, 148, 224, 242, 69, 165],
        }
    }
}

impl Default for WithdrawInsuranceVaultV2InstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct WithdrawInsuranceVaultV2InstructionArgs {
    pub percentage_amount: u64,
}

/// Instruction builder for `WithdrawInsuranceVaultV2`.
///
/// ### Accounts:
///
///   0. `[writable]` state
...
pub struct WithdrawInsuranceVaultV2Builder {
...
impl WithdrawInsuranceVaultV2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = WithdrawInsuranceVaultV2 {
        ...
        let args = WithdrawInsuranceVaultV2InstructionArgs {
...
/// `withdraw_insurance_vault_v2` CPI accounts.
pub struct WithdrawInsuranceVaultV2CpiAccounts<'a, 'b> {
...
/// `withdraw_insurance_vault_v2` CPI instruction.
pub struct WithdrawInsuranceVaultV2Cpi<'a, 'b> {
    ...
    pub __args: WithdrawInsuranceVaultV2InstructionArgs,
}

impl<'a, 'b> WithdrawInsuranceVaultV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: WithdrawInsuranceVaultV2CpiAccounts<'a, 'b>,
        args: WithdrawInsuranceVaultV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `WithdrawInsuranceVaultV2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` state
...
///   6. `[]` token_program
#[derive(Clone, Debug)]
pub struct WithdrawInsuranceVaultV2CpiBuilder<'a, 'b> {
    instruction: Box<WithdrawInsuranceVaultV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WithdrawInsuranceVaultV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(WithdrawInsuranceVaultV2CpiBuilderInstruction {
            __program: program,
            state: None,
            pricing: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = WithdrawInsuranceVaultV2Cpi {
...
#[derive(Clone, Debug)]
struct WithdrawInsuranceVaultV2CpiBuilderInstruction<'a, 'b> {
