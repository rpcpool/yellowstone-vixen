...
impl InitializeMarginAccount {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&InitializeMarginAccountInstructionData::new()).unwrap();
...
pub struct InitializeMarginAccountInstructionData {
    discriminator: [u8; 8],
}

impl InitializeMarginAccountInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [67, 235, 66, 102, 167, 171, 120, 197],
        }
    }
}

impl Default for InitializeMarginAccountInstructionData {
    fn default() -> Self { Self::new() }
}

/// Instruction builder for `InitializeMarginAccount`.
///
/// ### Accounts:
///
...
pub struct InitializeMarginAccountBuilder {
...
impl InitializeMarginAccountBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = InitializeMarginAccount {
...
/// `initialize_margin_account` CPI accounts.
pub struct InitializeMarginAccountCpiAccounts<'a, 'b> {
...
/// `initialize_margin_account` CPI instruction.
pub struct InitializeMarginAccountCpi<'a, 'b> {
...
impl<'a, 'b> InitializeMarginAccountCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: InitializeMarginAccountCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `InitializeMarginAccount` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` margin_account
...
///   5. `[]` zeta_group
#[derive(Clone, Debug)]
pub struct InitializeMarginAccountCpiBuilder<'a, 'b> {
    instruction: Box<InitializeMarginAccountCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InitializeMarginAccountCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(InitializeMarginAccountCpiBuilderInstruction {
            __program: program,
            margin_account: None,
            authority: None,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = InitializeMarginAccountCpi {
...
#[derive(Clone, Debug)]
struct InitializeMarginAccountCpiBuilderInstruction<'a, 'b> {
