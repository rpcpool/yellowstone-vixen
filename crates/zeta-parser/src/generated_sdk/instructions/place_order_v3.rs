...
impl PlaceOrderV3 {
    pub fn instruction(
        &self,
        args: PlaceOrderV3InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&PlaceOrderV3InstructionData::new()).unwrap();
...
pub struct PlaceOrderV3InstructionData {
    discriminator: [u8; 8],
}

impl PlaceOrderV3InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [146, 93, 14, 167, 159, 20, 6, 58],
        }
    }
}

impl Default for PlaceOrderV3InstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct PlaceOrderV3InstructionArgs {
    pub price: u64,
    pub size: u64,
    pub side: Side,
...
/// Instruction builder for `PlaceOrderV3`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct PlaceOrderV3Builder {
...
impl PlaceOrderV3Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = PlaceOrderV3InstructionArgs {
...
/// `place_order_v3` CPI accounts.
pub struct PlaceOrderV3CpiAccounts<'a, 'b> {
...
/// `place_order_v3` CPI instruction.
pub struct PlaceOrderV3Cpi<'a, 'b> {
    ...
    pub __args: PlaceOrderV3InstructionArgs,
}

impl<'a, 'b> PlaceOrderV3Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: PlaceOrderV3CpiAccounts<'a, 'b>,
        args: PlaceOrderV3InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `PlaceOrderV3` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   25. `[]` mint_authority
#[derive(Clone, Debug)]
pub struct PlaceOrderV3CpiBuilder<'a, 'b> {
    instruction: Box<PlaceOrderV3CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PlaceOrderV3CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(PlaceOrderV3CpiBuilderInstruction {
            __program: program,
            state: None,
            zeta_group: None,
            margin_account: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = PlaceOrderV3Cpi {
...
#[derive(Clone, Debug)]
struct PlaceOrderV3CpiBuilderInstruction<'a, 'b> {
