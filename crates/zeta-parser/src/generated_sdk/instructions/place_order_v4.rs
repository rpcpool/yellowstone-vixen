...
impl PlaceOrderV4 {
    pub fn instruction(
        &self,
        args: PlaceOrderV4InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&PlaceOrderV4InstructionData::new()).unwrap();
...
pub struct PlaceOrderV4InstructionData {
    discriminator: [u8; 8],
}

impl PlaceOrderV4InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [243, 248, 213, 143, 184, 79, 41, 73],
        }
    }
}

impl Default for PlaceOrderV4InstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct PlaceOrderV4InstructionArgs {
    pub price: u64,
    pub size: u64,
    pub side: Side,
...
/// Instruction builder for `PlaceOrderV4`.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   23. `[writable]` market_node
///   24. `[writable]` market_mint
///   25. `[]` mint_authority
#[derive(Clone, Debug, Default)]
pub struct PlaceOrderV4Builder {
...
impl PlaceOrderV4Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = PlaceOrderV4InstructionArgs {
...
/// `place_order_v4` CPI accounts.
pub struct PlaceOrderV4CpiAccounts<'a, 'b> {
...
/// `place_order_v4` CPI instruction.
pub struct PlaceOrderV4Cpi<'a, 'b> {
    ...
    pub __args: PlaceOrderV4InstructionArgs,
}

impl<'a, 'b> PlaceOrderV4Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: PlaceOrderV4CpiAccounts<'a, 'b>,
        args: PlaceOrderV4InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `PlaceOrderV4` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   25. `[]` mint_authority
#[derive(Clone, Debug)]
pub struct PlaceOrderV4CpiBuilder<'a, 'b> {
    instruction: Box<PlaceOrderV4CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PlaceOrderV4CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(PlaceOrderV4CpiBuilderInstruction {
            __program: program,
            state: None,
            zeta_group: None,
            margin_account: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = PlaceOrderV4Cpi {
...
#[derive(Clone, Debug)]
struct PlaceOrderV4CpiBuilderInstruction<'a, 'b> {
