...
impl ForceCancelOrderByOrderId {
    pub fn instruction(
        &self,
        args: ForceCancelOrderByOrderIdInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&ForceCancelOrderByOrderIdInstructionData::new()).unwrap();
...
pub struct ForceCancelOrderByOrderIdInstructionData {
    discriminator: [u8; 8],
}

impl ForceCancelOrderByOrderIdInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [182, 235, 48, 179, 248, 133, 210, 240],
        }
    }
}

impl Default for ForceCancelOrderByOrderIdInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ForceCancelOrderByOrderIdInstructionArgs {
    pub side: Side,
    pub order_id: u128,
    pub asset: Asset,
}

/// Instruction builder for `ForceCancelOrderByOrderId`.
///
/// ### Accounts:
///
///   0. `[]` zeta_group
...
pub struct ForceCancelOrderByOrderIdBuilder {
...
impl ForceCancelOrderByOrderIdBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = ForceCancelOrderByOrderId {
        ...
        let args = ForceCancelOrderByOrderIdInstructionArgs {
...
/// `force_cancel_order_by_order_id` CPI accounts.
pub struct ForceCancelOrderByOrderIdCpiAccounts<'a, 'b> {
...
/// `force_cancel_order_by_order_id` CPI instruction.
pub struct ForceCancelOrderByOrderIdCpi<'a, 'b> {
    ...
    pub __args: ForceCancelOrderByOrderIdInstructionArgs,
}

impl<'a, 'b> ForceCancelOrderByOrderIdCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ForceCancelOrderByOrderIdCpiAccounts<'a, 'b>,
        args: ForceCancelOrderByOrderIdInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ForceCancelOrderByOrderId` via CPI.
///
/// ### Accounts:
///
///   0. `[]` zeta_group
...
///   13. `[writable]` event_queue
#[derive(Clone, Debug)]
pub struct ForceCancelOrderByOrderIdCpiBuilder<'a, 'b> {
    instruction: Box<ForceCancelOrderByOrderIdCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ForceCancelOrderByOrderIdCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ForceCancelOrderByOrderIdCpiBuilderInstruction {
            __program: program,
            zeta_group: None,
            greeks: None,
            oracle: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ForceCancelOrderByOrderIdCpi {
...
#[derive(Clone, Debug)]
struct ForceCancelOrderByOrderIdCpiBuilderInstruction<'a, 'b> {
