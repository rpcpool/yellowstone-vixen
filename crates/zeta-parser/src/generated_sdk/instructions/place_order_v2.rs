...
impl PlaceOrderV2 {
    pub fn instruction(
        &self,
        args: PlaceOrderV2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&PlaceOrderV2InstructionData::new()).unwrap();
...
pub struct PlaceOrderV2InstructionData {
    discriminator: [u8; 8],
}

impl PlaceOrderV2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [232, 111, 115, 196, 237, 143, 62, 204],
        }
    }
}

impl Default for PlaceOrderV2InstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct PlaceOrderV2InstructionArgs {
    pub price: u64,
    pub size: u64,
    pub side: Side,
...
/// Instruction builder for `PlaceOrderV2`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct PlaceOrderV2Builder {
...
impl PlaceOrderV2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = PlaceOrderV2InstructionArgs {
...
/// `place_order_v2` CPI accounts.
pub struct PlaceOrderV2CpiAccounts<'a, 'b> {
...
/// `place_order_v2` CPI instruction.
pub struct PlaceOrderV2Cpi<'a, 'b> {
    ...
    pub __args: PlaceOrderV2InstructionArgs,
}

impl<'a, 'b> PlaceOrderV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: PlaceOrderV2CpiAccounts<'a, 'b>,
        args: PlaceOrderV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `PlaceOrderV2` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   25. `[]` mint_authority
#[derive(Clone, Debug)]
pub struct PlaceOrderV2CpiBuilder<'a, 'b> {
    instruction: Box<PlaceOrderV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PlaceOrderV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(PlaceOrderV2CpiBuilderInstruction {
            __program: program,
            state: None,
            zeta_group: None,
            margin_account: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = PlaceOrderV2Cpi {
...
#[derive(Clone, Debug)]
struct PlaceOrderV2CpiBuilderInstruction<'a, 'b> {
