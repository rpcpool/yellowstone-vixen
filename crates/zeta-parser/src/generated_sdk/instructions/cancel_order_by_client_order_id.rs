...
impl CancelOrderByClientOrderId {
    pub fn instruction(
        &self,
        args: CancelOrderByClientOrderIdInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&CancelOrderByClientOrderIdInstructionData::new()).unwrap();
...
pub struct CancelOrderByClientOrderIdInstructionData {
    discriminator: [u8; 8],
}

impl CancelOrderByClientOrderIdInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [115, 178, 201, 8, 175, 183, 123, 119],
        }
    }
}

impl Default for CancelOrderByClientOrderIdInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CancelOrderByClientOrderIdInstructionArgs {
    pub client_order_id: u64,
    pub asset: Asset,
}

/// Instruction builder for `CancelOrderByClientOrderId`.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
pub struct CancelOrderByClientOrderIdBuilder {
...
impl CancelOrderByClientOrderIdBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CancelOrderByClientOrderId {
        ...
        let args = CancelOrderByClientOrderIdInstructionArgs {
...
/// `cancel_order_by_client_order_id` CPI accounts.
pub struct CancelOrderByClientOrderIdCpiAccounts<'a, 'b> {
...
/// `cancel_order_by_client_order_id` CPI instruction.
pub struct CancelOrderByClientOrderIdCpi<'a, 'b> {
    ...
    pub __args: CancelOrderByClientOrderIdInstructionArgs,
}

impl<'a, 'b> CancelOrderByClientOrderIdCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CancelOrderByClientOrderIdCpiAccounts<'a, 'b>,
        args: CancelOrderByClientOrderIdInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CancelOrderByClientOrderId` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
///   9. `[writable]` event_queue
#[derive(Clone, Debug)]
pub struct CancelOrderByClientOrderIdCpiBuilder<'a, 'b> {
    instruction: Box<CancelOrderByClientOrderIdCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CancelOrderByClientOrderIdCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CancelOrderByClientOrderIdCpiBuilderInstruction {
            __program: program,
            authority: None,
            state: None,
            margin_account: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = CancelOrderByClientOrderIdCpi {
...
#[derive(Clone, Debug)]
struct CancelOrderByClientOrderIdCpiBuilderInstruction<'a, 'b> {
