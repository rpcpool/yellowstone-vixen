...
impl CancelAllMarketOrders {
    pub fn instruction(
        &self,
        args: CancelAllMarketOrdersInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&CancelAllMarketOrdersInstructionData::new()).unwrap();
...
pub struct CancelAllMarketOrdersInstructionData {
    discriminator: [u8; 8],
}

impl CancelAllMarketOrdersInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [139, 190, 230, 249, 77, 160, 206, 4],
        }
    }
}

impl Default for CancelAllMarketOrdersInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CancelAllMarketOrdersInstructionArgs {
    pub asset: Asset,
}

/// Instruction builder for `CancelAllMarketOrders`.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
pub struct CancelAllMarketOrdersBuilder {
...
impl CancelAllMarketOrdersBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CancelAllMarketOrders {
        ...
        let args = CancelAllMarketOrdersInstructionArgs {
...
/// `cancel_all_market_orders` CPI accounts.
pub struct CancelAllMarketOrdersCpiAccounts<'a, 'b> {
...
/// `cancel_all_market_orders` CPI instruction.
pub struct CancelAllMarketOrdersCpi<'a, 'b> {
    ...
    pub __args: CancelAllMarketOrdersInstructionArgs,
}

impl<'a, 'b> CancelAllMarketOrdersCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CancelAllMarketOrdersCpiAccounts<'a, 'b>,
        args: CancelAllMarketOrdersInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CancelAllMarketOrders` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
///   9. `[writable]` event_queue
#[derive(Clone, Debug)]
pub struct CancelAllMarketOrdersCpiBuilder<'a, 'b> {
    instruction: Box<CancelAllMarketOrdersCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CancelAllMarketOrdersCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CancelAllMarketOrdersCpiBuilderInstruction {
            __program: program,
            authority: None,
            state: None,
            margin_account: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = CancelAllMarketOrdersCpi {
...
#[derive(Clone, Debug)]
struct CancelAllMarketOrdersCpiBuilderInstruction<'a, 'b> {
