...
use crate::generated::types::TreasuryMovementType;
...
impl TreasuryMovement {
    pub fn instruction(
        &self,
        args: TreasuryMovementInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&TreasuryMovementInstructionData::new()).unwrap();
...
pub struct TreasuryMovementInstructionData {
    discriminator: [u8; 8],
}

impl TreasuryMovementInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [1, 34, 242, 105, 215, 211, 157, 18],
        }
    }
}

impl Default for TreasuryMovementInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct TreasuryMovementInstructionArgs {
    pub treasury_movement_type: TreasuryMovementType,
    pub amount: u64,
}

/// Instruction builder for `TreasuryMovement`.
///
/// ### Accounts:
///
///   0. `[]` state
///   1. `[writable]` insurance_vault
///   2. `[writable]` treasury_wallet
///   3. `[writable]` referrals_rewards_wallet
///   4. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
///   5. `[signer]` admin
#[derive(Clone, Debug, Default)]
pub struct TreasuryMovementBuilder {
    ...
    treasury_movement_type: Option<TreasuryMovementType>,
    amount: Option<u64>,
    __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl TreasuryMovementBuilder {
    ...
    #[inline(always)]
    pub fn treasury_movement_type(
        &mut self,
        treasury_movement_type: TreasuryMovementType,
    ) -> &mut Self {
        self.treasury_movement_type = Some(treasury_movement_type);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = TreasuryMovementInstructionArgs {
            treasury_movement_type: self
                .treasury_movement_type
                .clone()
                .expect("treasury_movement_type is not set"),
...
/// `treasury_movement` CPI accounts.
pub struct TreasuryMovementCpiAccounts<'a, 'b> {
...
/// `treasury_movement` CPI instruction.
pub struct TreasuryMovementCpi<'a, 'b> {
    ...
    pub __args: TreasuryMovementInstructionArgs,
}

impl<'a, 'b> TreasuryMovementCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: TreasuryMovementCpiAccounts<'a, 'b>,
        args: TreasuryMovementInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `TreasuryMovement` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   5. `[signer]` admin
#[derive(Clone, Debug)]
pub struct TreasuryMovementCpiBuilder<'a, 'b> {
    instruction: Box<TreasuryMovementCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> TreasuryMovementCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(TreasuryMovementCpiBuilderInstruction {
            __program: program,
            state: None,
    ...
    pub fn treasury_movement_type(
        ...
        self.instruction.treasury_movement_type = Some(treasury_movement_type);
        self
    }
    ...
    pub fn invoke_signed(
        ...
        let instruction = TreasuryMovementCpi {
...
#[derive(Clone, Debug)]
struct TreasuryMovementCpiBuilderInstruction<'a, 'b> {
