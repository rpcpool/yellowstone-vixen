...
impl ForceCancelOrderByOrderIdV2 {
    pub fn instruction(
        &self,
        args: ForceCancelOrderByOrderIdV2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&ForceCancelOrderByOrderIdV2InstructionData::new()).unwrap();
...
pub struct ForceCancelOrderByOrderIdV2InstructionData {
    discriminator: [u8; 8],
}

impl ForceCancelOrderByOrderIdV2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [81, 243, 60, 90, 222, 201, 41, 222],
        }
    }
}

impl Default for ForceCancelOrderByOrderIdV2InstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ForceCancelOrderByOrderIdV2InstructionArgs {
    pub side: Side,
    pub order_id: u128,
    pub asset: Asset,
}

/// Instruction builder for `ForceCancelOrderByOrderIdV2`.
///
/// ### Accounts:
///
///   0. `[]` pricing
///   1. `[]` oracle
///   2. `[]` oracle_backup_feed
///   3. `[]` oracle_backup_program
///   4. `[]` state
...
pub struct ForceCancelOrderByOrderIdV2Builder {
...
impl ForceCancelOrderByOrderIdV2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = ForceCancelOrderByOrderIdV2 {
        ...
        let args = ForceCancelOrderByOrderIdV2InstructionArgs {
...
/// `force_cancel_order_by_order_id_v2` CPI accounts.
pub struct ForceCancelOrderByOrderIdV2CpiAccounts<'a, 'b> {
...
/// `force_cancel_order_by_order_id_v2` CPI instruction.
pub struct ForceCancelOrderByOrderIdV2Cpi<'a, 'b> {
    ...
    pub __args: ForceCancelOrderByOrderIdV2InstructionArgs,
}

impl<'a, 'b> ForceCancelOrderByOrderIdV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ForceCancelOrderByOrderIdV2CpiAccounts<'a, 'b>,
        args: ForceCancelOrderByOrderIdV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ForceCancelOrderByOrderIdV2` via CPI.
///
/// ### Accounts:
///
///   0. `[]` pricing
...
///   12. `[writable]` event_queue
#[derive(Clone, Debug)]
pub struct ForceCancelOrderByOrderIdV2CpiBuilder<'a, 'b> {
    instruction: Box<ForceCancelOrderByOrderIdV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ForceCancelOrderByOrderIdV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ForceCancelOrderByOrderIdV2CpiBuilderInstruction {
            __program: program,
            pricing: None,
            oracle: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ForceCancelOrderByOrderIdV2Cpi {
...
#[derive(Clone, Debug)]
struct ForceCancelOrderByOrderIdV2CpiBuilderInstruction<'a, 'b> {
