...
impl ForceCancelOrdersV2 {
    pub fn instruction(
        &self,
        args: ForceCancelOrdersV2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&ForceCancelOrdersV2InstructionData::new()).unwrap();
...
pub struct ForceCancelOrdersV2InstructionData {
    discriminator: [u8; 8],
}

impl ForceCancelOrdersV2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [14, 62, 149, 202, 143, 17, 56, 115],
        }
    }
}

impl Default for ForceCancelOrdersV2InstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ForceCancelOrdersV2InstructionArgs {
    pub asset: Asset,
}

/// Instruction builder for `ForceCancelOrdersV2`.
///
/// ### Accounts:
///
///   0. `[]` pricing
...
pub struct ForceCancelOrdersV2Builder {
...
impl ForceCancelOrdersV2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = ForceCancelOrdersV2 {
        ...
        let args = ForceCancelOrdersV2InstructionArgs {
...
/// `force_cancel_orders_v2` CPI accounts.
pub struct ForceCancelOrdersV2CpiAccounts<'a, 'b> {
...
/// `force_cancel_orders_v2` CPI instruction.
pub struct ForceCancelOrdersV2Cpi<'a, 'b> {
    ...
    pub __args: ForceCancelOrdersV2InstructionArgs,
}

impl<'a, 'b> ForceCancelOrdersV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ForceCancelOrdersV2CpiAccounts<'a, 'b>,
        args: ForceCancelOrdersV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ForceCancelOrdersV2` via CPI.
///
/// ### Accounts:
///
///   0. `[]` pricing
...
///   12. `[writable]` event_queue
#[derive(Clone, Debug)]
pub struct ForceCancelOrdersV2CpiBuilder<'a, 'b> {
    instruction: Box<ForceCancelOrdersV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ForceCancelOrdersV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ForceCancelOrdersV2CpiBuilderInstruction {
            __program: program,
            pricing: None,
            oracle: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ForceCancelOrdersV2Cpi {
...
#[derive(Clone, Debug)]
struct ForceCancelOrdersV2CpiBuilderInstruction<'a, 'b> {
