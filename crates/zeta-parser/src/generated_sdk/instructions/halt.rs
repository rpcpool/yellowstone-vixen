...
impl Halt {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&HaltInstructionData::new()).unwrap();
...
impl HaltInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [24, 156, 8, 121, 65, 3, 5, 82],
        }
    }
}

impl Default for HaltInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct HaltInstructionArgs {
    pub asset: Asset,
}

/// Instruction builder for `Halt`.
///
/// ### Accounts:
///
///   0. `[writable]` state
...
/// `halt` CPI accounts.
pub struct HaltCpiAccounts<'a, 'b> {
...
/// `halt` CPI instruction.
pub struct HaltCpi<'a, 'b> {
    ...
    pub __args: HaltInstructionArgs,
}

impl<'a, 'b> HaltCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: HaltCpiAccounts<'a, 'b>,
        args: HaltInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `Halt` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` state
...
///   2. `[signer]` admin
#[derive(Clone, Debug)]
pub struct HaltCpiBuilder<'a, 'b> {
    instruction: Box<HaltCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> HaltCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(HaltCpiBuilderInstruction {
            __program: program,
            state: None,
            pricing: None,
            admin: None,
...
#[derive(Clone, Debug)]
struct HaltCpiBuilderInstruction<'a, 'b> {
