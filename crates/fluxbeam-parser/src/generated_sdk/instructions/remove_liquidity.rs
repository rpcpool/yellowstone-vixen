...
pub struct RemoveLiquidity {
    ...
    pub from_a: solana_program::pubkey::Pubkey,

    pub from_b: solana_program::pubkey::Pubkey,

    pub user_account_a: solana_program::pubkey::Pubkey,

    pub user_account_b: solana_program::pubkey::Pubkey,
...
///   10. `[]` mint_a
///   11. `[]` mint_b
///   12. `[]` pool_token_program_id
///   13. `[]` token_program_id_a
///   14. `[]` token_program_id_b
///   15. `[]` swap_program_id
...
pub struct RemoveLiquidityBuilder {
    ...
    from_a: Option<solana_program::pubkey::Pubkey>,
    from_b: Option<solana_program::pubkey::Pubkey>,
    user_account_a: Option<solana_program::pubkey::Pubkey>,
    user_account_b: Option<solana_program::pubkey::Pubkey>,
    ...
    minimum_token_a: Option<u64>,
    minimum_token_b: Option<u64>,
...
impl RemoveLiquidityBuilder {
    ...
    #[inline(always)]
    pub fn from_a(&mut self, from_a: solana_program::pubkey::Pubkey) -> &mut Self {
        self.from_a = Some(from_a);
        self
    }

    #[inline(always)]
    pub fn from_b(&mut self, from_b: solana_program::pubkey::Pubkey) -> &mut Self {
        self.from_b = Some(from_b);
        self
    }

    #[inline(always)]
    pub fn user_account_a(&mut self, user_account_a: solana_program::pubkey::Pubkey) -> &mut Self {
        self.user_account_a = Some(user_account_a);
        self
    }

    #[inline(always)]
    pub fn user_account_b(&mut self, user_account_b: solana_program::pubkey::Pubkey) -> &mut Self {
        self.user_account_b = Some(user_account_b);
        self
    }
    ...
    #[inline(always)]
    pub fn minimum_token_a(&mut self, minimum_token_a: u64) -> &mut Self {
        self.minimum_token_a = Some(minimum_token_a);
        self
    }

    #[inline(always)]
    pub fn minimum_token_b(&mut self, minimum_token_b: u64) -> &mut Self {
        self.minimum_token_b = Some(minimum_token_b);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = RemoveLiquidity {
            ...
            from_a: self.from_a.expect("from_a is not set"),
            from_b: self.from_b.expect("from_b is not set"),
            user_account_a: self.user_account_a.expect("user_account_a is not set"),
            user_account_b: self.user_account_b.expect("user_account_b is not set"),
        ...
        let args = RemoveLiquidityInstructionArgs {
            ...
            minimum_token_a: self
                .minimum_token_a
                .clone()
                .expect("minimum_token_a is not set"),
            minimum_token_b: self
                .minimum_token_b
                .clone()
                .expect("minimum_token_b is not set"),
        };
...
pub struct RemoveLiquidityCpiAccounts<'a, 'b> {
    ...
    pub from_a: &'b solana_program::account_info::AccountInfo<'a>,

    pub from_b: &'b solana_program::account_info::AccountInfo<'a>,

    pub user_account_a: &'b solana_program::account_info::AccountInfo<'a>,

    pub user_account_b: &'b solana_program::account_info::AccountInfo<'a>,
...
impl<'a, 'b> RemoveLiquidityCpi<'a, 'b> {
    pub fn new(
        ...
        Self {
            ...
            from_a: accounts.from_a,
            from_b: accounts.from_b,
            user_account_a: accounts.user_account_a,
            user_account_b: accounts.user_account_b,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        account_infos.push(self.from_a.clone());
        account_infos.push(self.from_b.clone());
        account_infos.push(self.user_account_a.clone());
        account_infos.push(self.user_account_b.clone());
...
impl<'a, 'b> RemoveLiquidityCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RemoveLiquidityCpiBuilderInstruction {
            ...
            minimum_token_a: None,
            minimum_token_b: None,
    ...
    pub fn from_a(
        &mut self,
        from_a: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.from_a = Some(from_a);
        self
    }
    ...
    pub fn from_b(
        &mut self,
        from_b: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.from_b = Some(from_b);
        self
    }

    #[inline(always)]
    pub fn user_account_a(
        &mut self,
        user_account_a: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.user_account_a = Some(user_account_a);
        self
    }

    #[inline(always)]
    pub fn user_account_b(
        &mut self,
        user_account_b: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.user_account_b = Some(user_account_b);
        self
    }
    ...
    #[inline(always)]
    pub fn minimum_token_a(&mut self, minimum_token_a: u64) -> &mut Self {
        self.instruction.minimum_token_a = Some(minimum_token_a);
        self
    }

    #[inline(always)]
    pub fn minimum_token_b(&mut self, minimum_token_b: u64) -> &mut Self {
        self.instruction.minimum_token_b = Some(minimum_token_b);
        self
    }
    ...
    pub fn invoke_signed(
        ...
        let instruction = RemoveLiquidityCpi {
            ...
            from_a: self.instruction.from_a.expect("from_a is not set"),

            from_b: self.instruction.from_b.expect("from_b is not set"),

            user_account_a: self
                .instruction
                .user_account_a
                .expect("user_account_a is not set"),

            user_account_b: self
                .instruction
                .user_account_b
                .expect("user_account_b is not set"),
...
struct RemoveLiquidityCpiBuilderInstruction<'a, 'b> {
    ...
    from_a: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    from_b: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    user_account_a: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    user_account_b: Option<&'b solana_program::account_info::AccountInfo<'a>>,
