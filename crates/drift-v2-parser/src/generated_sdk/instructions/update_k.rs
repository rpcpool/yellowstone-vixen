...
impl UpdateK {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&UpdateKInstructionData::new()).unwrap();
...
pub struct UpdateKInstructionData {
    discriminator: [u8; 8],
}

impl UpdateKInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for UpdateKInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct UpdateKInstructionArgs {
    pub sqrt_k: u128,
}

/// Instruction builder for `UpdateK`.
///
/// ### Accounts:
///
///   0. `[signer]` admin
...
/// `update_k` CPI accounts.
pub struct UpdateKCpiAccounts<'a, 'b> {
...
/// `update_k` CPI instruction.
pub struct UpdateKCpi<'a, 'b> {
    ...
    pub __args: UpdateKInstructionArgs,
}

impl<'a, 'b> UpdateKCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UpdateKCpiAccounts<'a, 'b>,
        args: UpdateKInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `UpdateK` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` admin
...
///   3. `[]` oracle
#[derive(Clone, Debug)]
pub struct UpdateKCpiBuilder<'a, 'b> {
    instruction: Box<UpdateKCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdateKCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdateKCpiBuilderInstruction {
            __program: program,
            admin: None,
            state: None,
            perp_market: None,
...
#[derive(Clone, Debug)]
struct UpdateKCpiBuilderInstruction<'a, 'b> {
