...
impl UpdateSpotMarketCumulativeInterest {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data =
            borsh::to_vec(&UpdateSpotMarketCumulativeInterestInstructionData::new()).unwrap();
...
pub struct UpdateSpotMarketCumulativeInterestInstructionData {
    discriminator: [u8; 8],
}

impl UpdateSpotMarketCumulativeInterestInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for UpdateSpotMarketCumulativeInterestInstructionData {
    fn default() -> Self { Self::new() }
}

/// Instruction builder for `UpdateSpotMarketCumulativeInterest`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct UpdateSpotMarketCumulativeInterestBuilder {
...
impl UpdateSpotMarketCumulativeInterestBuilder {
...
/// `update_spot_market_cumulative_interest` CPI accounts.
pub struct UpdateSpotMarketCumulativeInterestCpiAccounts<'a, 'b> {
...
/// `update_spot_market_cumulative_interest` CPI instruction.
pub struct UpdateSpotMarketCumulativeInterestCpi<'a, 'b> {
...
impl<'a, 'b> UpdateSpotMarketCumulativeInterestCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UpdateSpotMarketCumulativeInterestCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `UpdateSpotMarketCumulativeInterest` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   3. `[]` spot_market_vault
#[derive(Clone, Debug)]
pub struct UpdateSpotMarketCumulativeInterestCpiBuilder<'a, 'b> {
    instruction: Box<UpdateSpotMarketCumulativeInterestCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdateSpotMarketCumulativeInterestCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdateSpotMarketCumulativeInterestCpiBuilderInstruction {
            __program: program,
            state: None,
            spot_market: None,
            oracle: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = UpdateSpotMarketCumulativeInterestCpi {
...
#[derive(Clone, Debug)]
struct UpdateSpotMarketCumulativeInterestCpiBuilderInstruction<'a, 'b> {
