...
impl UpdatePrelaunchOracle {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&UpdatePrelaunchOracleInstructionData::new()).unwrap();
...
pub struct UpdatePrelaunchOracleInstructionData {
    discriminator: [u8; 8],
}

impl UpdatePrelaunchOracleInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for UpdatePrelaunchOracleInstructionData {
    fn default() -> Self { Self::new() }
}

/// Instruction builder for `UpdatePrelaunchOracle`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct UpdatePrelaunchOracleBuilder {
...
impl UpdatePrelaunchOracleBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = UpdatePrelaunchOracle {
...
/// `update_prelaunch_oracle` CPI accounts.
pub struct UpdatePrelaunchOracleCpiAccounts<'a, 'b> {
...
/// `update_prelaunch_oracle` CPI instruction.
pub struct UpdatePrelaunchOracleCpi<'a, 'b> {
...
impl<'a, 'b> UpdatePrelaunchOracleCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UpdatePrelaunchOracleCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `UpdatePrelaunchOracle` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   2. `[writable]` oracle
#[derive(Clone, Debug)]
pub struct UpdatePrelaunchOracleCpiBuilder<'a, 'b> {
    instruction: Box<UpdatePrelaunchOracleCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdatePrelaunchOracleCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdatePrelaunchOracleCpiBuilderInstruction {
            __program: program,
            state: None,
            perp_market: None,
            oracle: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = UpdatePrelaunchOracleCpi {
...
#[derive(Clone, Debug)]
struct UpdatePrelaunchOracleCpiBuilderInstruction<'a, 'b> {
