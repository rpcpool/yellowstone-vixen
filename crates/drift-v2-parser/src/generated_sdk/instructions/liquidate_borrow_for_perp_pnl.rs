...
impl LiquidateBorrowForPerpPnl {
    pub fn instruction(
        &self,
        args: LiquidateBorrowForPerpPnlInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&LiquidateBorrowForPerpPnlInstructionData::new()).unwrap();
...
pub struct LiquidateBorrowForPerpPnlInstructionData {
    discriminator: [u8; 8],
}

impl LiquidateBorrowForPerpPnlInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for LiquidateBorrowForPerpPnlInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct LiquidateBorrowForPerpPnlInstructionArgs {
...
/// Instruction builder for `LiquidateBorrowForPerpPnl`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct LiquidateBorrowForPerpPnlBuilder {
...
impl LiquidateBorrowForPerpPnlBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = LiquidateBorrowForPerpPnl {
        ...
        let args = LiquidateBorrowForPerpPnlInstructionArgs {
...
/// `liquidate_borrow_for_perp_pnl` CPI accounts.
pub struct LiquidateBorrowForPerpPnlCpiAccounts<'a, 'b> {
...
/// `liquidate_borrow_for_perp_pnl` CPI instruction.
pub struct LiquidateBorrowForPerpPnlCpi<'a, 'b> {
    ...
    pub __args: LiquidateBorrowForPerpPnlInstructionArgs,
}

impl<'a, 'b> LiquidateBorrowForPerpPnlCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: LiquidateBorrowForPerpPnlCpiAccounts<'a, 'b>,
        args: LiquidateBorrowForPerpPnlInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `LiquidateBorrowForPerpPnl` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   5. `[writable]` user_stats
#[derive(Clone, Debug)]
pub struct LiquidateBorrowForPerpPnlCpiBuilder<'a, 'b> {
    instruction: Box<LiquidateBorrowForPerpPnlCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> LiquidateBorrowForPerpPnlCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(LiquidateBorrowForPerpPnlCpiBuilderInstruction {
            __program: program,
            state: None,
            authority: None,
            liquidator: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = LiquidateBorrowForPerpPnlCpi {
...
#[derive(Clone, Debug)]
struct LiquidateBorrowForPerpPnlCpiBuilderInstruction<'a, 'b> {
