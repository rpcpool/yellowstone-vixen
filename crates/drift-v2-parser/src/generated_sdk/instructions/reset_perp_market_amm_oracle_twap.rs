...
impl ResetPerpMarketAmmOracleTwap {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&ResetPerpMarketAmmOracleTwapInstructionData::new()).unwrap();
...
pub struct ResetPerpMarketAmmOracleTwapInstructionData {
    discriminator: [u8; 8],
}

impl ResetPerpMarketAmmOracleTwapInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for ResetPerpMarketAmmOracleTwapInstructionData {
    fn default() -> Self { Self::new() }
}

/// Instruction builder for `ResetPerpMarketAmmOracleTwap`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct ResetPerpMarketAmmOracleTwapBuilder {
...
impl ResetPerpMarketAmmOracleTwapBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = ResetPerpMarketAmmOracleTwap {
...
/// `reset_perp_market_amm_oracle_twap` CPI accounts.
pub struct ResetPerpMarketAmmOracleTwapCpiAccounts<'a, 'b> {
...
/// `reset_perp_market_amm_oracle_twap` CPI instruction.
pub struct ResetPerpMarketAmmOracleTwapCpi<'a, 'b> {
...
impl<'a, 'b> ResetPerpMarketAmmOracleTwapCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ResetPerpMarketAmmOracleTwapCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ResetPerpMarketAmmOracleTwap` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   3. `[signer]` admin
#[derive(Clone, Debug)]
pub struct ResetPerpMarketAmmOracleTwapCpiBuilder<'a, 'b> {
    instruction: Box<ResetPerpMarketAmmOracleTwapCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ResetPerpMarketAmmOracleTwapCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ResetPerpMarketAmmOracleTwapCpiBuilderInstruction {
            __program: program,
            state: None,
            perp_market: None,
            oracle: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ResetPerpMarketAmmOracleTwapCpi {
...
#[derive(Clone, Debug)]
struct ResetPerpMarketAmmOracleTwapCpiBuilderInstruction<'a, 'b> {
