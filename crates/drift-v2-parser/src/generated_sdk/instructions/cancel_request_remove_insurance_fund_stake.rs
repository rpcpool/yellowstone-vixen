...
impl CancelRequestRemoveInsuranceFundStake {
    pub fn instruction(
        &self,
        args: CancelRequestRemoveInsuranceFundStakeInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data =
            borsh::to_vec(&CancelRequestRemoveInsuranceFundStakeInstructionData::new()).unwrap();
...
pub struct CancelRequestRemoveInsuranceFundStakeInstructionData {
    discriminator: [u8; 8],
}

impl CancelRequestRemoveInsuranceFundStakeInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for CancelRequestRemoveInsuranceFundStakeInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CancelRequestRemoveInsuranceFundStakeInstructionArgs {
    pub market_index: u16,
}

/// Instruction builder for `CancelRequestRemoveInsuranceFundStake`.
///
/// ### Accounts:
///
...
pub struct CancelRequestRemoveInsuranceFundStakeBuilder {
...
impl CancelRequestRemoveInsuranceFundStakeBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CancelRequestRemoveInsuranceFundStake {
        ...
        let args = CancelRequestRemoveInsuranceFundStakeInstructionArgs {
...
/// `cancel_request_remove_insurance_fund_stake` CPI accounts.
pub struct CancelRequestRemoveInsuranceFundStakeCpiAccounts<'a, 'b> {
...
/// `cancel_request_remove_insurance_fund_stake` CPI instruction.
pub struct CancelRequestRemoveInsuranceFundStakeCpi<'a, 'b> {
    ...
    pub __args: CancelRequestRemoveInsuranceFundStakeInstructionArgs,
}

impl<'a, 'b> CancelRequestRemoveInsuranceFundStakeCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CancelRequestRemoveInsuranceFundStakeCpiAccounts<'a, 'b>,
        args: CancelRequestRemoveInsuranceFundStakeInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CancelRequestRemoveInsuranceFundStake` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` spot_market
...
///   4. `[writable]` insurance_fund_vault
#[derive(Clone, Debug)]
pub struct CancelRequestRemoveInsuranceFundStakeCpiBuilder<'a, 'b> {
    instruction: Box<CancelRequestRemoveInsuranceFundStakeCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CancelRequestRemoveInsuranceFundStakeCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CancelRequestRemoveInsuranceFundStakeCpiBuilderInstruction {
            __program: program,
            spot_market: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = CancelRequestRemoveInsuranceFundStakeCpi {
...
#[derive(Clone, Debug)]
struct CancelRequestRemoveInsuranceFundStakeCpiBuilderInstruction<'a, 'b> {
