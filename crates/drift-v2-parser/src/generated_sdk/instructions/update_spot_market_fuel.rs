...
impl UpdateSpotMarketFuel {
    pub fn instruction(
        &self,
        args: UpdateSpotMarketFuelInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&UpdateSpotMarketFuelInstructionData::new()).unwrap();
...
pub struct UpdateSpotMarketFuelInstructionData {
    discriminator: [u8; 8],
}

impl UpdateSpotMarketFuelInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for UpdateSpotMarketFuelInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct UpdateSpotMarketFuelInstructionArgs {
...
/// Instruction builder for `UpdateSpotMarketFuel`.
///
/// ### Accounts:
///
///   0. `[signer]` admin
...
pub struct UpdateSpotMarketFuelBuilder {
...
impl UpdateSpotMarketFuelBuilder {
    ...
    /// `[optional argument]`
    #[inline(always)]
    pub fn fuel_boost_deposits(&mut self, fuel_boost_deposits: u8) -> &mut Self {
    ...
    /// `[optional argument]`
    #[inline(always)]
    pub fn fuel_boost_borrows(&mut self, fuel_boost_borrows: u8) -> &mut Self {
    ...
    /// `[optional argument]`
    #[inline(always)]
    pub fn fuel_boost_insurance(&mut self, fuel_boost_insurance: u8) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = UpdateSpotMarketFuel {
            admin: self.admin.expect("admin is not set"),
            state: self.state.expect("state is not set"),
            spot_market: self.spot_market.expect("spot_market is not set"),
        };
        let args = UpdateSpotMarketFuelInstructionArgs {
...
/// `update_spot_market_fuel` CPI accounts.
pub struct UpdateSpotMarketFuelCpiAccounts<'a, 'b> {
...
/// `update_spot_market_fuel` CPI instruction.
pub struct UpdateSpotMarketFuelCpi<'a, 'b> {
    ...
    pub __args: UpdateSpotMarketFuelInstructionArgs,
}

impl<'a, 'b> UpdateSpotMarketFuelCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UpdateSpotMarketFuelCpiAccounts<'a, 'b>,
        args: UpdateSpotMarketFuelInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `UpdateSpotMarketFuel` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` admin
...
///   2. `[writable]` spot_market
#[derive(Clone, Debug)]
pub struct UpdateSpotMarketFuelCpiBuilder<'a, 'b> {
    instruction: Box<UpdateSpotMarketFuelCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdateSpotMarketFuelCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdateSpotMarketFuelCpiBuilderInstruction {
            __program: program,
            admin: None,
            state: None,
            spot_market: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = UpdateSpotMarketFuelCpi {
...
#[derive(Clone, Debug)]
struct UpdateSpotMarketFuelCpiBuilderInstruction<'a, 'b> {
