...
impl LiquidateSpot {
    pub fn instruction(
        &self,
        args: LiquidateSpotInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&LiquidateSpotInstructionData::new()).unwrap();
...
pub struct LiquidateSpotInstructionData {
    discriminator: [u8; 8],
}

impl LiquidateSpotInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for LiquidateSpotInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct LiquidateSpotInstructionArgs {
...
/// Instruction builder for `LiquidateSpot`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct LiquidateSpotBuilder {
    ...
    liquidator_max_liability_transfer: Option<u128>,
    limit_price: Option<u64>,
    __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl LiquidateSpotBuilder {
    ...
    #[inline(always)]
    pub fn liquidator_max_liability_transfer(
        &mut self,
        liquidator_max_liability_transfer: u128,
    ) -> &mut Self {
        self.liquidator_max_liability_transfer = Some(liquidator_max_liability_transfer);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = LiquidateSpotInstructionArgs {
            ...
            liquidator_max_liability_transfer: self
                .liquidator_max_liability_transfer
                .clone()
                .expect("liquidator_max_liability_transfer is not set"),
...
/// `liquidate_spot` CPI accounts.
pub struct LiquidateSpotCpiAccounts<'a, 'b> {
...
/// `liquidate_spot` CPI instruction.
pub struct LiquidateSpotCpi<'a, 'b> {
    ...
    pub __args: LiquidateSpotInstructionArgs,
}

impl<'a, 'b> LiquidateSpotCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: LiquidateSpotCpiAccounts<'a, 'b>,
        args: LiquidateSpotInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `LiquidateSpot` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   5. `[writable]` user_stats
#[derive(Clone, Debug)]
pub struct LiquidateSpotCpiBuilder<'a, 'b> {
    instruction: Box<LiquidateSpotCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> LiquidateSpotCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(LiquidateSpotCpiBuilderInstruction {
            __program: program,
            state: None,
            authority: None,
            liquidator: None,
            ...
            liquidator_max_liability_transfer: None,
            limit_price: None,
    ...
    pub fn liquidator_max_liability_transfer(
        ...
        self.instruction.liquidator_max_liability_transfer =
            Some(liquidator_max_liability_transfer);
        self
    }
    ...
    pub fn invoke_signed(
        ...
        let instruction = LiquidateSpotCpi {
...
#[derive(Clone, Debug)]
struct LiquidateSpotCpiBuilderInstruction<'a, 'b> {
