...
impl ResolvePerpPnlDeficit {
    pub fn instruction(
        &self,
        args: ResolvePerpPnlDeficitInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&ResolvePerpPnlDeficitInstructionData::new()).unwrap();
...
pub struct ResolvePerpPnlDeficitInstructionData {
    discriminator: [u8; 8],
}

impl ResolvePerpPnlDeficitInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for ResolvePerpPnlDeficitInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ResolvePerpPnlDeficitInstructionArgs {
    pub spot_market_index: u16,
    pub perp_market_index: u16,
}

/// Instruction builder for `ResolvePerpPnlDeficit`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct ResolvePerpPnlDeficitBuilder {
...
impl ResolvePerpPnlDeficitBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = ResolvePerpPnlDeficit {
        ...
        let args = ResolvePerpPnlDeficitInstructionArgs {
...
/// `resolve_perp_pnl_deficit` CPI accounts.
pub struct ResolvePerpPnlDeficitCpiAccounts<'a, 'b> {
...
/// `resolve_perp_pnl_deficit` CPI instruction.
pub struct ResolvePerpPnlDeficitCpi<'a, 'b> {
    ...
    pub __args: ResolvePerpPnlDeficitInstructionArgs,
}

impl<'a, 'b> ResolvePerpPnlDeficitCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ResolvePerpPnlDeficitCpiAccounts<'a, 'b>,
        args: ResolvePerpPnlDeficitInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ResolvePerpPnlDeficit` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   5. `[]` token_program
#[derive(Clone, Debug)]
pub struct ResolvePerpPnlDeficitCpiBuilder<'a, 'b> {
    instruction: Box<ResolvePerpPnlDeficitCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ResolvePerpPnlDeficitCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ResolvePerpPnlDeficitCpiBuilderInstruction {
            __program: program,
            state: None,
            authority: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ResolvePerpPnlDeficitCpi {
...
#[derive(Clone, Debug)]
struct ResolvePerpPnlDeficitCpiBuilderInstruction<'a, 'b> {
