...
impl ResolveSpotBankruptcy {
    pub fn instruction(
        &self,
        args: ResolveSpotBankruptcyInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&ResolveSpotBankruptcyInstructionData::new()).unwrap();
...
pub struct ResolveSpotBankruptcyInstructionData {
    discriminator: [u8; 8],
}

impl ResolveSpotBankruptcyInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for ResolveSpotBankruptcyInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ResolveSpotBankruptcyInstructionArgs {
    pub market_index: u16,
}

/// Instruction builder for `ResolveSpotBankruptcy`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct ResolveSpotBankruptcyBuilder {
...
impl ResolveSpotBankruptcyBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = ResolveSpotBankruptcy {
        ...
        let args = ResolveSpotBankruptcyInstructionArgs {
...
/// `resolve_spot_bankruptcy` CPI accounts.
pub struct ResolveSpotBankruptcyCpiAccounts<'a, 'b> {
...
/// `resolve_spot_bankruptcy` CPI instruction.
pub struct ResolveSpotBankruptcyCpi<'a, 'b> {
    ...
    pub __args: ResolveSpotBankruptcyInstructionArgs,
}

impl<'a, 'b> ResolveSpotBankruptcyCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ResolveSpotBankruptcyCpiAccounts<'a, 'b>,
        args: ResolveSpotBankruptcyInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ResolveSpotBankruptcy` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   9. `[]` token_program
#[derive(Clone, Debug)]
pub struct ResolveSpotBankruptcyCpiBuilder<'a, 'b> {
    instruction: Box<ResolveSpotBankruptcyCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ResolveSpotBankruptcyCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ResolveSpotBankruptcyCpiBuilderInstruction {
            __program: program,
            state: None,
            authority: None,
            liquidator: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ResolveSpotBankruptcyCpi {
...
#[derive(Clone, Debug)]
struct ResolveSpotBankruptcyCpiBuilderInstruction<'a, 'b> {
