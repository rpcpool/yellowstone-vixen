...
impl UpdateUserGovTokenInsuranceStake {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&UpdateUserGovTokenInsuranceStakeInstructionData::new()).unwrap();
...
pub struct UpdateUserGovTokenInsuranceStakeInstructionData {
    discriminator: [u8; 8],
}

impl UpdateUserGovTokenInsuranceStakeInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for UpdateUserGovTokenInsuranceStakeInstructionData {
    fn default() -> Self { Self::new() }
}

/// Instruction builder for `UpdateUserGovTokenInsuranceStake`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct UpdateUserGovTokenInsuranceStakeBuilder {
...
impl UpdateUserGovTokenInsuranceStakeBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = UpdateUserGovTokenInsuranceStake {
...
/// `update_user_gov_token_insurance_stake` CPI accounts.
pub struct UpdateUserGovTokenInsuranceStakeCpiAccounts<'a, 'b> {
...
/// `update_user_gov_token_insurance_stake` CPI instruction.
pub struct UpdateUserGovTokenInsuranceStakeCpi<'a, 'b> {
...
impl<'a, 'b> UpdateUserGovTokenInsuranceStakeCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UpdateUserGovTokenInsuranceStakeCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `UpdateUserGovTokenInsuranceStake` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   5. `[writable]` insurance_fund_vault
#[derive(Clone, Debug)]
pub struct UpdateUserGovTokenInsuranceStakeCpiBuilder<'a, 'b> {
    instruction: Box<UpdateUserGovTokenInsuranceStakeCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdateUserGovTokenInsuranceStakeCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdateUserGovTokenInsuranceStakeCpiBuilderInstruction {
            __program: program,
            state: None,
            spot_market: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = UpdateUserGovTokenInsuranceStakeCpi {
...
#[derive(Clone, Debug)]
struct UpdateUserGovTokenInsuranceStakeCpiBuilderInstruction<'a, 'b> {
