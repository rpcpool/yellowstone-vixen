...
impl ResolvePerpBankruptcy {
    pub fn instruction(
        &self,
        args: ResolvePerpBankruptcyInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&ResolvePerpBankruptcyInstructionData::new()).unwrap();
...
pub struct ResolvePerpBankruptcyInstructionData {
    discriminator: [u8; 8],
}

impl ResolvePerpBankruptcyInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for ResolvePerpBankruptcyInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ResolvePerpBankruptcyInstructionArgs {
    pub quote_spot_market_index: u16,
    pub market_index: u16,
}

/// Instruction builder for `ResolvePerpBankruptcy`.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   7. `[writable]` insurance_fund_vault
///   8. `[]` drift_signer
///   9. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
#[derive(Clone, Debug, Default)]
pub struct ResolvePerpBankruptcyBuilder {
...
impl ResolvePerpBankruptcyBuilder {
    ...
    #[inline(always)]
    pub fn quote_spot_market_index(&mut self, quote_spot_market_index: u16) -> &mut Self {
        self.quote_spot_market_index = Some(quote_spot_market_index);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = ResolvePerpBankruptcy {
        ...
        let args = ResolvePerpBankruptcyInstructionArgs {
            quote_spot_market_index: self
                .quote_spot_market_index
                .clone()
                .expect("quote_spot_market_index is not set"),
...
/// `resolve_perp_bankruptcy` CPI accounts.
pub struct ResolvePerpBankruptcyCpiAccounts<'a, 'b> {
...
/// `resolve_perp_bankruptcy` CPI instruction.
pub struct ResolvePerpBankruptcyCpi<'a, 'b> {
    ...
    pub __args: ResolvePerpBankruptcyInstructionArgs,
}

impl<'a, 'b> ResolvePerpBankruptcyCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ResolvePerpBankruptcyCpiAccounts<'a, 'b>,
        args: ResolvePerpBankruptcyInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ResolvePerpBankruptcy` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   9. `[]` token_program
#[derive(Clone, Debug)]
pub struct ResolvePerpBankruptcyCpiBuilder<'a, 'b> {
    instruction: Box<ResolvePerpBankruptcyCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ResolvePerpBankruptcyCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ResolvePerpBankruptcyCpiBuilderInstruction {
            __program: program,
            state: None,
            authority: None,
            liquidator: None,
    ...
    #[inline(always)]
    pub fn quote_spot_market_index(&mut self, quote_spot_market_index: u16) -> &mut Self {
        self.instruction.quote_spot_market_index = Some(quote_spot_market_index);
        self
    }
    ...
    pub fn invoke_signed(
        ...
        let instruction = ResolvePerpBankruptcyCpi {
...
#[derive(Clone, Debug)]
struct ResolvePerpBankruptcyCpiBuilderInstruction<'a, 'b> {
