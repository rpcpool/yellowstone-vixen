...
impl AddInsuranceFundStake {
    pub fn instruction(
        &self,
        args: AddInsuranceFundStakeInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&AddInsuranceFundStakeInstructionData::new()).unwrap();
...
pub struct AddInsuranceFundStakeInstructionData {
    discriminator: [u8; 8],
}

impl AddInsuranceFundStakeInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for AddInsuranceFundStakeInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct AddInsuranceFundStakeInstructionArgs {
    pub market_index: u16,
    pub amount: u64,
}

/// Instruction builder for `AddInsuranceFundStake`.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   4. `[signer]` authority
///   5. `[writable]` spot_market_vault
///   6. `[writable]` insurance_fund_vault
///   7. `[]` drift_signer
///   8. `[writable]` user_token_account
///   9. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
#[derive(Clone, Debug, Default)]
pub struct AddInsuranceFundStakeBuilder {
...
impl AddInsuranceFundStakeBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = AddInsuranceFundStake {
        ...
        let args = AddInsuranceFundStakeInstructionArgs {
...
/// `add_insurance_fund_stake` CPI accounts.
pub struct AddInsuranceFundStakeCpiAccounts<'a, 'b> {
...
/// `add_insurance_fund_stake` CPI instruction.
pub struct AddInsuranceFundStakeCpi<'a, 'b> {
    ...
    pub __args: AddInsuranceFundStakeInstructionArgs,
}

impl<'a, 'b> AddInsuranceFundStakeCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: AddInsuranceFundStakeCpiAccounts<'a, 'b>,
        args: AddInsuranceFundStakeInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddInsuranceFundStake` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   9. `[]` token_program
#[derive(Clone, Debug)]
pub struct AddInsuranceFundStakeCpiBuilder<'a, 'b> {
    instruction: Box<AddInsuranceFundStakeCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddInsuranceFundStakeCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddInsuranceFundStakeCpiBuilderInstruction {
            __program: program,
            state: None,
            spot_market: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = AddInsuranceFundStakeCpi {
...
#[derive(Clone, Debug)]
struct AddInsuranceFundStakeCpiBuilderInstruction<'a, 'b> {
