...
impl LiquidatePerpWithFill {
    pub fn instruction(
        &self,
        args: LiquidatePerpWithFillInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&LiquidatePerpWithFillInstructionData::new()).unwrap();
...
pub struct LiquidatePerpWithFillInstructionData {
    discriminator: [u8; 8],
}

impl LiquidatePerpWithFillInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for LiquidatePerpWithFillInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct LiquidatePerpWithFillInstructionArgs {
    pub market_index: u16,
}

/// Instruction builder for `LiquidatePerpWithFill`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct LiquidatePerpWithFillBuilder {
...
impl LiquidatePerpWithFillBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = LiquidatePerpWithFill {
        ...
        let args = LiquidatePerpWithFillInstructionArgs {
...
/// `liquidate_perp_with_fill` CPI accounts.
pub struct LiquidatePerpWithFillCpiAccounts<'a, 'b> {
...
/// `liquidate_perp_with_fill` CPI instruction.
pub struct LiquidatePerpWithFillCpi<'a, 'b> {
    ...
    pub __args: LiquidatePerpWithFillInstructionArgs,
}

impl<'a, 'b> LiquidatePerpWithFillCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: LiquidatePerpWithFillCpiAccounts<'a, 'b>,
        args: LiquidatePerpWithFillInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `LiquidatePerpWithFill` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   5. `[writable]` user_stats
#[derive(Clone, Debug)]
pub struct LiquidatePerpWithFillCpiBuilder<'a, 'b> {
    instruction: Box<LiquidatePerpWithFillCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> LiquidatePerpWithFillCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(LiquidatePerpWithFillCpiBuilderInstruction {
            __program: program,
            state: None,
            authority: None,
            liquidator: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = LiquidatePerpWithFillCpi {
...
#[derive(Clone, Debug)]
struct LiquidatePerpWithFillCpiBuilderInstruction<'a, 'b> {
