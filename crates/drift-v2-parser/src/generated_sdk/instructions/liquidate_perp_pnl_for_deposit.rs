...
impl LiquidatePerpPnlForDeposit {
    pub fn instruction(
        &self,
        args: LiquidatePerpPnlForDepositInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&LiquidatePerpPnlForDepositInstructionData::new()).unwrap();
...
pub struct LiquidatePerpPnlForDepositInstructionData {
    discriminator: [u8; 8],
}

impl LiquidatePerpPnlForDepositInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for LiquidatePerpPnlForDepositInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct LiquidatePerpPnlForDepositInstructionArgs {
...
/// Instruction builder for `LiquidatePerpPnlForDeposit`.
///
/// ### Accounts:
///
///   0. `[]` state
...
pub struct LiquidatePerpPnlForDepositBuilder {
    ...
    liquidator_max_pnl_transfer: Option<u128>,
    limit_price: Option<u64>,
    __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl LiquidatePerpPnlForDepositBuilder {
    ...
    #[inline(always)]
    pub fn liquidator_max_pnl_transfer(&mut self, liquidator_max_pnl_transfer: u128) -> &mut Self {
        self.liquidator_max_pnl_transfer = Some(liquidator_max_pnl_transfer);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = LiquidatePerpPnlForDeposit {
        ...
        let args = LiquidatePerpPnlForDepositInstructionArgs {
            ...
            liquidator_max_pnl_transfer: self
                .liquidator_max_pnl_transfer
                .clone()
                .expect("liquidator_max_pnl_transfer is not set"),
...
/// `liquidate_perp_pnl_for_deposit` CPI accounts.
pub struct LiquidatePerpPnlForDepositCpiAccounts<'a, 'b> {
...
/// `liquidate_perp_pnl_for_deposit` CPI instruction.
pub struct LiquidatePerpPnlForDepositCpi<'a, 'b> {
    ...
    pub __args: LiquidatePerpPnlForDepositInstructionArgs,
}

impl<'a, 'b> LiquidatePerpPnlForDepositCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: LiquidatePerpPnlForDepositCpiAccounts<'a, 'b>,
        args: LiquidatePerpPnlForDepositInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `LiquidatePerpPnlForDeposit` via CPI.
///
/// ### Accounts:
///
///   0. `[]` state
...
///   5. `[writable]` user_stats
#[derive(Clone, Debug)]
pub struct LiquidatePerpPnlForDepositCpiBuilder<'a, 'b> {
    instruction: Box<LiquidatePerpPnlForDepositCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> LiquidatePerpPnlForDepositCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(LiquidatePerpPnlForDepositCpiBuilderInstruction {
            __program: program,
            state: None,
            authority: None,
            liquidator: None,
            ...
            liquidator_max_pnl_transfer: None,
            limit_price: None,
    ...
    #[inline(always)]
    pub fn liquidator_max_pnl_transfer(&mut self, liquidator_max_pnl_transfer: u128) -> &mut Self {
        self.instruction.liquidator_max_pnl_transfer = Some(liquidator_max_pnl_transfer);
        self
    }
    ...
    pub fn invoke_signed(
        ...
        let instruction = LiquidatePerpPnlForDepositCpi {
...
#[derive(Clone, Debug)]
struct LiquidatePerpPnlForDepositCpiBuilderInstruction<'a, 'b> {
