...
#[vixen_proto]
#[derive(Clone, PartialEq)]
pub struct InitializeAccount2Instruction {
...
#[vixen_proto]
#[derive(Clone, PartialEq)]
pub struct InitializeAccount3Instruction {
    pub accounts: Option<super::InitializeAccount2Accounts>,
    pub args: Option<super::InitializeAccount2Args>,
}
...
#[vixen_proto]
#[derive(Clone, PartialEq)]
pub struct ApproveCheckedInstruction {
...
#[vixen_proto]
#[derive(Clone, PartialEq)]
pub struct MintToCheckedInstruction {
...
#[vixen_proto]
#[derive(Clone, PartialEq)]
pub struct BurnCheckedInstruction {
...
#[vixen_proto]
#[derive(Clone, PartialEq)]
pub struct GetAccountDataSizeInstruction {
...
#[vixen_proto]
#[derive(Clone, PartialEq)]
pub struct AmountToUiAmountInstruction {
...
#[vixen_proto]
#[derive(Clone, PartialEq)]
pub struct UiAmountToAmountInstruction {
...
pub enum Instruction {
    ...
    InitializeMint(InitializeMintInstruction),
    InitializeAccount(InitializeAccountInstruction),
    InitializeAccount2(InitializeAccount2Instruction),
    InitializeAccount3(InitializeAccount3Instruction),
    InitializeMultisig(InitializeMultisigInstruction),
    Approve(ApproveInstruction),
    Revoke(RevokeInstruction),
    SetAuthority(SetAuthorityInstruction),
    MintTo(MintToInstruction),
    Burn(BurnInstruction),
    CloseAccount(CloseAccountInstruction),
    FreezeAccount(FreezeAccountInstruction),
    ThawAccount(ThawAccountInstruction),
    TransferChecked(TransferCheckedInstruction),
    ApproveChecked(ApproveCheckedInstruction),
    MintToChecked(MintToCheckedInstruction),
    BurnChecked(BurnCheckedInstruction),
    SyncNative(SyncNativeInstruction),
    GetAccountDataSize(GetAccountDataSizeInstruction),
    InitializeImmutableOwner(InitializeImmutableOwnerInstruction),
    AmountToUiAmount(AmountToUiAmountInstruction),
    UiAmountToAmount(UiAmountToAmountInstruction),
}
