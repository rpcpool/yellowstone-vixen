...
impl Invest {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = borsh::to_vec(&InvestInstructionData::new()).unwrap();
...
///
          ...
          ///   12. `[]` klend_program
          ///   13. `[]` reserve_collateral_token_program
...
impl InvestBuilder {
  pub fn new() -> Self {
    ...
    pub fn payer(&mut self, payer: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn payer_token_account(&mut self, payer_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = Invest {
                              payer: self.payer.expect("payer is not set"),
                                        payer_token_account: self.payer_token_account.expect("payer_token_account is not set"),
...
impl<'a, 'b> InvestCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn payer(&mut self, payer: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn payer_token_account(&mut self, payer_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          payer_token_account: self.instruction.payer_token_account.expect("payer_token_account is not set"),
