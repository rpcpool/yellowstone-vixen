...
impl WithdrawFromAvailable {
  pub fn instruction(&self, args: WithdrawFromAvailableInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: WithdrawFromAvailableInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&WithdrawFromAvailableInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct WithdrawFromAvailableInstructionData {
            discriminator: [u8; 8],
            }

impl WithdrawFromAvailableInstructionData {
  pub fn new() -> Self {
    Self {
...
impl Default for WithdrawFromAvailableInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct WithdrawFromAvailableInstructionArgs {
                  pub shares_amount: u64,
      }


/// Instruction builder for `WithdrawFromAvailable`.
///
/// ### Accounts:
///
          ...
          ///   3. `[]` base_vault_authority
                ...
                ///   6. `[writable]` user_shares_ata
                ///   7. `[writable]` shares_mint
                ///   8. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
          ///   9. `[]` shares_token_program
          ///   10. `[]` klend_program
#[derive(Clone, Debug, Default)]
pub struct WithdrawFromAvailableBuilder {
...
impl WithdrawFromAvailableBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = WithdrawFromAvailable {
          ...
          let args = WithdrawFromAvailableInstructionArgs {
                                                              shares_amount: self.shares_amount.clone().expect("shares_amount is not set"),
                                    };
  ...
  /// `withdraw_from_available` CPI accounts.
  pub struct WithdrawFromAvailableCpiAccounts<'a, 'b> {
...
/// `withdraw_from_available` CPI instruction.
pub struct WithdrawFromAvailableCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: WithdrawFromAvailableInstructionArgs,
  }

impl<'a, 'b> WithdrawFromAvailableCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: WithdrawFromAvailableCpiAccounts<'a, 'b>,
              args: WithdrawFromAvailableInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
              user: accounts.user,
...
/// Instruction builder for `WithdrawFromAvailable` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` user
          ...
          ///   10. `[]` klend_program
#[derive(Clone, Debug)]
pub struct WithdrawFromAvailableCpiBuilder<'a, 'b> {
  instruction: Box<WithdrawFromAvailableCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WithdrawFromAvailableCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(WithdrawFromAvailableCpiBuilderInstruction {
      __program: program,
              user: None,
              vault_state: None,
              token_vault: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = WithdrawFromAvailableInstructionArgs {
                                                              shares_amount: self.instruction.shares_amount.clone().expect("shares_amount is not set"),
                                    };
        let instruction = WithdrawFromAvailableCpi {
...
#[derive(Clone, Debug)]
struct WithdrawFromAvailableCpiBuilderInstruction<'a, 'b> {
