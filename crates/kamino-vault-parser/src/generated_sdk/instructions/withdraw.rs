...
///   10. `[]` klend_program
///   11. `[writable]` vault_state
///   12. `[writable]` reserve
///   13. `[writable]` ctoken_vault
///   14. `[]` lending_market
///   15. `[]` lending_market_authority
///   16. `[writable]` reserve_liquidity_supply
///   17. `[writable]` reserve_collateral_mint
///   18. `[]` reserve_collateral_token_program
...
impl WithdrawBuilder {
    ...
    #[inline(always)]
    pub fn shares_token_program(
        &mut self,
        shares_token_program: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    #[inline(always)]
    pub fn reserve_collateral_token_program(
        &mut self,
        reserve_collateral_token_program: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = Withdraw {
            ...
            shares_token_program: self
                .shares_token_program
                .expect("shares_token_program is not set"),
            ...
            reserve_collateral_token_program: self
                .reserve_collateral_token_program
                .expect("reserve_collateral_token_program is not set"),
...
impl<'a, 'b> WithdrawCpiBuilder<'a, 'b> {
    ...
    pub fn vault_state(
        &mut self,
        vault_state: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn shares_token_program(
        &mut self,
        shares_token_program: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    #[inline(always)]
    pub fn klend_program(
        &mut self,
        klend_program: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn ctoken_vault(
        &mut self,
        ctoken_vault: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn reserve_collateral_token_program(
        &mut self,
        reserve_collateral_token_program: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(
        ...
        let instruction = WithdrawCpi {
            ...
            klend_program: self
                .instruction
                .klend_program
                .expect("klend_program is not set"),
            ...
            ctoken_vault: self
                .instruction
                .ctoken_vault
                .expect("ctoken_vault is not set"),
