...
pub struct SweepFees {
    ...
    pub token_receiver_account: solana_program::pubkey::Pubkey,
...
/// ### Accounts:
///
///   0. `[signer]` collect_fee_admin
///   1. `[writable]` market
///   2. `[]` market_authority
///   3. `[writable]` market_quote_vault
///   4. `[writable]` token_receiver_account
...
pub struct SweepFeesBuilder {
    ...
    token_receiver_account: Option<solana_program::pubkey::Pubkey>,
...
impl SweepFeesBuilder {
    ...
    #[inline(always)]
    pub fn token_receiver_account(
        &mut self,
        token_receiver_account: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
        self.token_receiver_account = Some(token_receiver_account);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = SweepFees {
            ...
            token_receiver_account: self
                .token_receiver_account
                .expect("token_receiver_account is not set"),
...
pub struct SweepFeesCpiAccounts<'a, 'b> {
    ...
    pub token_receiver_account: &'b solana_program::account_info::AccountInfo<'a>,
...
impl<'a, 'b> SweepFeesCpi<'a, 'b> {
    pub fn new(
        ...
        Self {
            ...
            token_receiver_account: accounts.token_receiver_account,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(
            *self.token_receiver_account.key,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
        ...
        account_infos.push(self.token_receiver_account.clone());
...
impl<'a, 'b> SweepFeesCpiBuilder<'a, 'b> {
    ...
    pub fn token_receiver_account(
        &mut self,
        token_receiver_account: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.token_receiver_account = Some(token_receiver_account);
        self
    }
...
struct SweepFeesCpiBuilderInstruction<'a, 'b> {
    ...
    token_receiver_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
