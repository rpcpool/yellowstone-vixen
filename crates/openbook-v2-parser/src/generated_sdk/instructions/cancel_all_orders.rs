...
impl CancelAllOrders {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&CancelAllOrdersInstructionData::new()).unwrap();
...
impl CancelAllOrdersInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [196, 83, 243, 171, 17, 100, 160, 143],
        }
    }
}
...
impl CancelAllOrdersBuilder {
    ...
    /// `[optional argument]`
    #[inline(always)]
    pub fn side_option(&mut self, side_option: Side) -> &mut Self {
        self.side_option = Some(side_option);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = CancelAllOrdersInstructionArgs {
            side_option: self.side_option.clone(),
...
impl<'a, 'b> CancelAllOrdersCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn side_option(&mut self, side_option: Side) -> &mut Self {
        self.instruction.side_option = Some(side_option);
        self
    }
    ...
    pub fn invoke_signed(
        ...
        let args = CancelAllOrdersInstructionArgs {
            side_option: self.instruction.side_option.clone(),
