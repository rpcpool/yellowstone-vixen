...
impl Refill {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&RefillInstructionData::new()).unwrap();
...
pub struct RefillInstructionData {
    discriminator: [u8; 8],
}

impl RefillInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [128, 207, 142, 11, 54, 232, 38, 201],
        }
    }
}

impl Default for RefillInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct RefillInstructionArgs {
    pub base_amount: u64,
    pub quote_amount: u64,
}

/// Instruction builder for `Refill`.
///
/// ### Accounts:
///
///   0. `[signer]` owner
...
impl RefillBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = RefillInstructionArgs {
...
/// `refill` CPI accounts.
pub struct RefillCpiAccounts<'a, 'b> {
...
/// `refill` CPI instruction.
pub struct RefillCpi<'a, 'b> {
    ...
    pub __args: RefillInstructionArgs,
}

impl<'a, 'b> RefillCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: RefillCpiAccounts<'a, 'b>,
        args: RefillInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `Refill` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` owner
...
///   7. `[]` token_program
#[derive(Clone, Debug)]
pub struct RefillCpiBuilder<'a, 'b> {
    instruction: Box<RefillCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RefillCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RefillCpiBuilderInstruction {
            __program: program,
            owner: None,
...
#[derive(Clone, Debug)]
struct RefillCpiBuilderInstruction<'a, 'b> {
