...
impl SettleFundsExpired {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&SettleFundsExpiredInstructionData::new()).unwrap();
...
pub struct SettleFundsExpiredInstructionData {
    discriminator: [u8; 8],
}

impl SettleFundsExpiredInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [107, 18, 56, 69, 228, 56, 55, 164],
        }
    }
}

impl Default for SettleFundsExpiredInstructionData {
    fn default() -> Self { Self::new() }
}

/// Instruction builder for `SettleFundsExpired`.
///
/// ### Accounts:
///
///   0. `[signer]` close_market_admin
///   1. `[writable, signer]` owner
///   2. `[writable, signer]` penalty_payer
///   3. `[writable]` open_orders_account
///   4. `[writable]` market
///   5. `[]` market_authority
///   6. `[writable]` market_base_vault
///   7. `[writable]` market_quote_vault
///   8. `[writable]` user_base_account
///   9. `[writable]` user_quote_account
///   10. `[writable, optional]` referrer_account
///   11. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
///   12. `[optional]` system_program (default to `11111111111111111111111111111111`)
#[derive(Clone, Debug, Default)]
pub struct SettleFundsExpiredBuilder {
...
impl SettleFundsExpiredBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = SettleFundsExpired {
...
/// `settle_funds_expired` CPI accounts.
pub struct SettleFundsExpiredCpiAccounts<'a, 'b> {
...
/// `settle_funds_expired` CPI instruction.
pub struct SettleFundsExpiredCpi<'a, 'b> {
...
impl<'a, 'b> SettleFundsExpiredCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: SettleFundsExpiredCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SettleFundsExpired` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` close_market_admin
...
///   12. `[]` system_program
#[derive(Clone, Debug)]
pub struct SettleFundsExpiredCpiBuilder<'a, 'b> {
    instruction: Box<SettleFundsExpiredCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SettleFundsExpiredCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SettleFundsExpiredCpiBuilderInstruction {
            __program: program,
    ...
    pub fn invoke_signed(
        ...
        let instruction = SettleFundsExpiredCpi {
...
#[derive(Clone, Debug)]
struct SettleFundsExpiredCpiBuilderInstruction<'a, 'b> {
