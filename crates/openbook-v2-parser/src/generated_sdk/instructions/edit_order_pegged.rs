...
impl EditOrderPegged {
    pub fn instruction(
        &self,
        args: EditOrderPeggedInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&EditOrderPeggedInstructionData::new()).unwrap();
...
pub struct EditOrderPeggedInstructionData {
    discriminator: [u8; 8],
}

impl EditOrderPeggedInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [62, 187, 125, 69, 26, 221, 157, 133],
        }
    }
}

impl Default for EditOrderPeggedInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct EditOrderPeggedInstructionArgs {
    pub client_order_id: u64,
    pub expected_cancel_size: i64,
    pub place_order: PlaceOrderPeggedArgs,
}

/// Instruction builder for `EditOrderPegged`.
///
/// ### Accounts:
///
///   0. `[signer]` signer
...
pub struct EditOrderPeggedBuilder {
    ...
    expected_cancel_size: Option<i64>,
    place_order: Option<PlaceOrderPeggedArgs>,
    __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl EditOrderPeggedBuilder {
    ...
    #[inline(always)]
    pub fn expected_cancel_size(&mut self, expected_cancel_size: i64) -> &mut Self {
        self.expected_cancel_size = Some(expected_cancel_size);
        self
    }

    #[inline(always)]
    pub fn place_order(&mut self, place_order: PlaceOrderPeggedArgs) -> &mut Self {
        self.place_order = Some(place_order);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = EditOrderPeggedInstructionArgs {
            client_order_id: self
                .client_order_id
                .clone()
                .expect("client_order_id is not set"),
            expected_cancel_size: self
                .expected_cancel_size
                .clone()
                .expect("expected_cancel_size is not set"),
            place_order: self.place_order.clone().expect("place_order is not set"),
        };
...
/// `edit_order_pegged` CPI accounts.
pub struct EditOrderPeggedCpiAccounts<'a, 'b> {
...
/// `edit_order_pegged` CPI instruction.
pub struct EditOrderPeggedCpi<'a, 'b> {
    ...
    pub __args: EditOrderPeggedInstructionArgs,
}

impl<'a, 'b> EditOrderPeggedCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: EditOrderPeggedCpiAccounts<'a, 'b>,
        args: EditOrderPeggedInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `EditOrderPegged` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` signer
...
///   11. `[]` token_program
#[derive(Clone, Debug)]
pub struct EditOrderPeggedCpiBuilder<'a, 'b> {
    instruction: Box<EditOrderPeggedCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> EditOrderPeggedCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(EditOrderPeggedCpiBuilderInstruction {
            __program: program,
            signer: None,
    ...
    #[inline(always)]
    pub fn expected_cancel_size(&mut self, expected_cancel_size: i64) -> &mut Self {
        self.instruction.expected_cancel_size = Some(expected_cancel_size);
        self
    }

    #[inline(always)]
    pub fn place_order(&mut self, place_order: PlaceOrderPeggedArgs) -> &mut Self {
        self.instruction.place_order = Some(place_order);
        self
    }
    ...
    pub fn invoke_signed(
        ...
        let args = EditOrderPeggedInstructionArgs {
            ...
            place_order: self
                ...
                .place_order
                .clone()
                .expect("place_order is not set"),
        };
        let instruction = EditOrderPeggedCpi {
...
#[derive(Clone, Debug)]
struct EditOrderPeggedCpiBuilderInstruction<'a, 'b> {
