...
use crate::generated::types::PlaceOrderArgs;
...
impl EditOrder {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&EditOrderInstructionData::new()).unwrap();
...
impl EditOrderInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [254, 208, 118, 29, 173, 248, 200, 70],
        }
    }
}
...
pub struct EditOrderBuilder {
    ...
    place_order: Option<PlaceOrderArgs>,
...
impl EditOrderBuilder {
    ...
    #[inline(always)]
    pub fn place_order(&mut self, place_order: PlaceOrderArgs) -> &mut Self {
