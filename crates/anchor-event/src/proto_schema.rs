...
/// schema describing `ProgramEventOutput`.
///
...
/// - Appends an `ProgramEventOutput` wrapper message with:
...
/// `wrapper_message_index` is the 0-based position of the `ProgramEventOutput`
...
pub fn merge_proto_schemas(ix_schema: &str, event_schema: &str) -> (String, i32) {
    ...
    let total = ix_messages.len() + emitted_count + 1; // +1 for ProgramEventOutput
...
";
        ...
        // Wrapper message
        assert!(combined.contains("message ProgramEventOutput {"));
