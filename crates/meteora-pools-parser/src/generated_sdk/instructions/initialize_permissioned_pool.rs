...
impl InitializePermissionedPool {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(self.pool, true));
        ...
        let mut data = borsh::to_vec(&InitializePermissionedPoolInstructionData::new()).unwrap();
...
pub struct InitializePermissionedPoolBuilder {
    ...
    admin_token_a: Option<solana_pubkey::Pubkey>,
    admin_token_b: Option<solana_pubkey::Pubkey>,
    admin_pool_lp: Option<solana_pubkey::Pubkey>,
    ...
    fee_owner: Option<solana_pubkey::Pubkey>,
...
impl InitializePermissionedPoolBuilder {
    ...
    /// Admin token account for pool token A mint. Used to bootstrap the pool with initial liquidity.
    #[inline(always)]
    pub fn admin_token_a(&mut self, admin_token_a: solana_pubkey::Pubkey) -> &mut Self {
    ...
    /// Admin token account for pool token B mint. Used to bootstrap the pool with initial liquidity.
    #[inline(always)]
    pub fn admin_token_b(&mut self, admin_token_b: solana_pubkey::Pubkey) -> &mut Self {
    ...
    /// Admin pool LP token account. Used to receive LP during first deposit (initialize pool)
    #[inline(always)]
    pub fn admin_pool_lp(&mut self, admin_pool_lp: solana_pubkey::Pubkey) -> &mut Self {
    ...
    #[inline(always)]
    pub fn fee_owner(&mut self, fee_owner: solana_pubkey::Pubkey) -> &mut Self {
...
pub struct InitializePermissionedPoolCpiAccounts<'a, 'b> {
    ...
    /// Admin pool LP token account. Used to receive LP during first deposit (initialize pool)
    /// Admin pool LP token account. Used to receive LP during first deposit (initialize pool)
    pub admin_pool_lp: &'b solana_account_info::AccountInfo<'a>,
    /// Protocol fee token account for token A. Used to receive trading fee.
    ...
    pub fee_owner: &'b solana_account_info::AccountInfo<'a>,
    /// Rent account.
...
impl<'a, 'b> InitializePermissionedPoolCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        let mut accounts = Vec::with_capacity(24 + remaining_accounts.len());
        accounts.push(solana_instruction::AccountMeta::new(*self.pool.key, true));
        accounts.push(solana_instruction::AccountMeta::new(
            *self.lp_mint.key,
            false,
        ));
...
impl<'a, 'b> InitializePermissionedPoolCpiBuilder<'a, 'b> {
    ...
    pub fn admin_token_a(
        &mut self,
        admin_token_a: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn admin_token_b(
        &mut self,
        admin_token_b: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn admin_pool_lp(
        &mut self,
        admin_pool_lp: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    #[inline(always)]
    pub fn fee_owner(&mut self, fee_owner: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
