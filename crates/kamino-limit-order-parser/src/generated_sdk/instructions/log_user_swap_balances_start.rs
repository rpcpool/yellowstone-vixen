...
impl LogUserSwapBalancesStart {
    pub fn instruction(
        &self,
        args: LogUserSwapBalancesStartInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&LogUserSwapBalancesStartInstructionData::new()).unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct LogUserSwapBalancesStartInstructionArgs {
...
impl LogUserSwapBalancesStartBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = LogUserSwapBalancesStartInstructionArgs {
...
pub struct LogUserSwapBalancesStartCpi<'a, 'b> {
    ...
    pub __args: LogUserSwapBalancesStartInstructionArgs,
}
