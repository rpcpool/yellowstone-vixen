...
impl FlashTakeOrderEnd {
    pub fn instruction(
        &self,
        args: FlashTakeOrderEndInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&FlashTakeOrderEndInstructionData::new()).unwrap();
...
pub struct FlashTakeOrderEndInstructionData {
    discriminator: [u8; 8],
}

impl FlashTakeOrderEndInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [206, 242, 215, 187, 134, 33, 224, 148],
        }
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct FlashTakeOrderEndInstructionArgs {
    pub input_amount: u64,
    pub min_output_amount: u64,
    pub tip_amount_permissionless_taking: u64,
}

/// Instruction builder for `FlashTakeOrderEnd`.
///
/// ### Accounts:
///
...
pub struct FlashTakeOrderEndBuilder {
...
impl FlashTakeOrderEndBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = FlashTakeOrderEnd {
        ...
        let args = FlashTakeOrderEndInstructionArgs {
...
/// `flash_take_order_end` CPI accounts.
pub struct FlashTakeOrderEndCpiAccounts<'a, 'b> {
...
/// `flash_take_order_end` CPI instruction.
pub struct FlashTakeOrderEndCpi<'a, 'b> {
    ...
    pub __args: FlashTakeOrderEndInstructionArgs,
}

impl<'a, 'b> FlashTakeOrderEndCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: FlashTakeOrderEndCpiAccounts<'a, 'b>,
        args: FlashTakeOrderEndInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `FlashTakeOrderEnd` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` taker
...
///   22. `[]` program
#[derive(Clone, Debug)]
pub struct FlashTakeOrderEndCpiBuilder<'a, 'b> {
    instruction: Box<FlashTakeOrderEndCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> FlashTakeOrderEndCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(FlashTakeOrderEndCpiBuilderInstruction {
            __program: program,
            taker: None,
            maker: None,
            global_config: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = FlashTakeOrderEndCpi {
...
#[derive(Clone, Debug)]
struct FlashTakeOrderEndCpiBuilderInstruction<'a, 'b> {
