...
impl BuyBuilder {
    ...
    #[inline(always)]
    pub fn max_amount_out(&mut self, max_amount_out: u64) -> &mut Self {
        self.max_amount_out = Some(max_amount_out);
        self
    }
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = BuyInstructionArgs {
            ...
            max_amount_out: self
                .max_amount_out
                .clone()
                .expect("max_amount_out is not set"),
        };
...
impl<'a, 'b> BuyCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn max_amount_out(&mut self, max_amount_out: u64) -> &mut Self {
        self.instruction.max_amount_out = Some(max_amount_out);
        self
    }
