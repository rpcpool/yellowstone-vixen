...
pub struct Withdraw {
    ...
    pub token0_account: solana_program::pubkey::Pubkey,
    /// The owner's token account for receive token_1
    pub token1_account: solana_program::pubkey::Pubkey,
...
pub struct WithdrawBuilder {
    ...
    token0_account: Option<solana_program::pubkey::Pubkey>,
    token1_account: Option<solana_program::pubkey::Pubkey>,
...
impl WithdrawBuilder {
    ...
    /// The owner's token account for receive token_0
    #[inline(always)]
    pub fn token0_account(&mut self, token0_account: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    /// The owner's token account for receive token_1
    #[inline(always)]
    pub fn token1_account(&mut self, token1_account: solana_program::pubkey::Pubkey) -> &mut Self {
...
pub struct WithdrawCpiAccounts<'a, 'b> {
    ...
    /// The owner's token account for receive token_0
    pub token0_account: &'b solana_program::account_info::AccountInfo<'a>,
    /// The owner's token account for receive token_1
    pub token1_account: &'b solana_program::account_info::AccountInfo<'a>,
    /// The address that holds pool tokens for token_0
...
impl<'a, 'b> WithdrawCpiBuilder<'a, 'b> {
    ...
    pub fn token0_account(
        &mut self,
        token0_account: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn token1_account(
        &mut self,
        token1_account: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct WithdrawCpiBuilderInstruction<'a, 'b> {
    ...
    token0_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    token1_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
