...
pub struct FlashFillOrderBuilder {
    ...
    input_mint_token_program: Option<solana_pubkey::Pubkey>,
    output_mint: Option<solana_pubkey::Pubkey>,
    output_mint_token_program: Option<solana_pubkey::Pubkey>,
...
impl FlashFillOrderBuilder {
    ...
    pub fn input_mint_token_program(
        &mut self,
        input_mint_token_program: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn output_mint_token_program(
        &mut self,
        output_mint_token_program: solana_pubkey::Pubkey,
    ) -> &mut Self {
...
pub struct FlashFillOrderCpiAccounts<'a, 'b> {
    ...
    pub output_mint_token_program: &'b solana_account_info::AccountInfo<'a>,
...
impl<'a, 'b> FlashFillOrderCpiBuilder<'a, 'b> {
    ...
    pub fn output_mint_token_program(
        &mut self,
        output_mint_token_program: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct FlashFillOrderCpiBuilderInstruction<'a, 'b> {
    ...
    output_mint_token_program: Option<&'b solana_account_info::AccountInfo<'a>>,
