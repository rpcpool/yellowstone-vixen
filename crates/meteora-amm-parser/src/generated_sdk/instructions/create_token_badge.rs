...
pub const CREATE_TOKEN_BADGE_DISCRIMINATOR: [u8; 8] = [88, 206, 0, 91, 60, 175, 151, 118];
...
impl CreateTokenBadge {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&CreateTokenBadgeInstructionData::new()).unwrap();
...
pub struct CreateTokenBadgeInstructionData {
    discriminator: [u8; 8],
}

impl CreateTokenBadgeInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for CreateTokenBadgeInstructionData {
    fn default() -> Self { Self::new() }
}

/// Instruction builder for `CreateTokenBadge`.
///
/// ### Accounts:
///
...
pub struct CreateTokenBadgeBuilder {
...
/// `create_token_badge` CPI accounts.
pub struct CreateTokenBadgeCpiAccounts<'a, 'b> {
...
/// `create_token_badge` CPI instruction.
pub struct CreateTokenBadgeCpi<'a, 'b> {
...
impl<'a, 'b> CreateTokenBadgeCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: CreateTokenBadgeCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CreateTokenBadge` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` token_badge
...
///   5. `[]` program
#[derive(Clone, Debug)]
pub struct CreateTokenBadgeCpiBuilder<'a, 'b> {
    instruction: Box<CreateTokenBadgeCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CreateTokenBadgeCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CreateTokenBadgeCpiBuilderInstruction {
            __program: program,
            token_badge: None,
            token_mint: None,
            admin: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = CreateTokenBadgeCpi {
...
#[derive(Clone, Debug)]
struct CreateTokenBadgeCpiBuilderInstruction<'a, 'b> {
