...
impl CommissionSplSwap {
    pub fn instruction(
        &self,
        args: CommissionSplSwapInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&CommissionSplSwapInstructionData::new()).unwrap();
...
pub struct CommissionSplSwapInstructionData {
    discriminator: [u8; 8],
}

impl CommissionSplSwapInstructionData {
    pub fn new() -> Self {
        Self {
...
/// Instruction builder for `CommissionSplSwap`.
///
/// ### Accounts:
///
///   0. `[signer]` payer
...
pub struct CommissionSplSwapBuilder {
...
impl CommissionSplSwapBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = CommissionSplSwapInstructionArgs {
...
/// `commission_spl_swap` CPI accounts.
pub struct CommissionSplSwapCpiAccounts<'a, 'b> {
...
/// `commission_spl_swap` CPI instruction.
pub struct CommissionSplSwapCpi<'a, 'b> {
    ...
    pub __args: CommissionSplSwapInstructionArgs,
}

impl<'a, 'b> CommissionSplSwapCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CommissionSplSwapCpiAccounts<'a, 'b>,
        args: CommissionSplSwapInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CommissionSplSwap` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` payer
...
///   6. `[]` token_program
#[derive(Clone, Debug)]
pub struct CommissionSplSwapCpiBuilder<'a, 'b> {
    instruction: Box<CommissionSplSwapCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CommissionSplSwapCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CommissionSplSwapCpiBuilderInstruction {
            __program: program,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = CommissionSplSwapCpi {
...
#[derive(Clone, Debug)]
struct CommissionSplSwapCpiBuilderInstruction<'a, 'b> {
