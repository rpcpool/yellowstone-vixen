...
impl CommissionSplSwap2 {
    pub fn instruction(
        &self,
        args: CommissionSplSwap2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&CommissionSplSwap2InstructionData::new()).unwrap();
...
pub struct CommissionSplSwap2InstructionData {
    discriminator: [u8; 8],
}

impl CommissionSplSwap2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [173, 131, 78, 38, 150, 165, 123, 15],
        }
    }
}

impl Default for CommissionSplSwap2InstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CommissionSplSwap2InstructionArgs {
    pub data: CommissionSwapArgs,
    pub order_id: u64,
}

/// Instruction builder for `CommissionSplSwap2`.
///
/// ### Accounts:
///
///   0. `[signer]` payer
...
pub struct CommissionSplSwap2Builder {
...
impl CommissionSplSwap2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CommissionSplSwap2 {
        ...
        let args = CommissionSplSwap2InstructionArgs {
...
/// `commission_spl_swap2` CPI accounts.
pub struct CommissionSplSwap2CpiAccounts<'a, 'b> {
...
/// `commission_spl_swap2` CPI instruction.
pub struct CommissionSplSwap2Cpi<'a, 'b> {
    ...
    pub __args: CommissionSplSwap2InstructionArgs,
}

impl<'a, 'b> CommissionSplSwap2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CommissionSplSwap2CpiAccounts<'a, 'b>,
        args: CommissionSplSwap2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CommissionSplSwap2` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` payer
...
///   6. `[]` token_program
#[derive(Clone, Debug)]
pub struct CommissionSplSwap2CpiBuilder<'a, 'b> {
    instruction: Box<CommissionSplSwap2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CommissionSplSwap2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CommissionSplSwap2CpiBuilderInstruction {
            __program: program,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = CommissionSplSwap2Cpi {
...
#[derive(Clone, Debug)]
struct CommissionSplSwap2CpiBuilderInstruction<'a, 'b> {
