...
pub struct CommissionSplFromSwap {
    ...
    pub commission_token_account: solana_program::pubkey::Pubkey,
}

impl CommissionSplFromSwap {
    pub fn instruction(
        &self,
        args: CommissionSplFromSwapInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&CommissionSplFromSwapInstructionData::new()).unwrap();
...
pub struct CommissionSplFromSwapInstructionData {
    discriminator: [u8; 8],
}

impl CommissionSplFromSwapInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for CommissionSplFromSwapInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CommissionSplFromSwapInstructionArgs {
    pub args: SwapArgs,
...
/// Instruction builder for `CommissionSplFromSwap`.
///
/// ### Accounts:
///
...
///   10. `[writable]` commission_token_account
#[derive(Clone, Debug, Default)]
pub struct CommissionSplFromSwapBuilder {
    ...
    commission_token_account: Option<solana_program::pubkey::Pubkey>,
...
impl CommissionSplFromSwapBuilder {
    ...
    pub fn commission_token_account(
        &mut self,
        commission_token_account: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CommissionSplFromSwap {
        ...
        let args = CommissionSplFromSwapInstructionArgs {
...
/// `commission_spl_from_swap` CPI accounts.
pub struct CommissionSplFromSwapCpiAccounts<'a, 'b> {
    ...
    pub commission_token_account: &'b solana_program::account_info::AccountInfo<'a>,
}

/// `commission_spl_from_swap` CPI instruction.
pub struct CommissionSplFromSwapCpi<'a, 'b> {
    ...
    pub __args: CommissionSplFromSwapInstructionArgs,
}

impl<'a, 'b> CommissionSplFromSwapCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CommissionSplFromSwapCpiAccounts<'a, 'b>,
        args: CommissionSplFromSwapInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CommissionSplFromSwap` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   10. `[writable]` commission_token_account
#[derive(Clone, Debug)]
pub struct CommissionSplFromSwapCpiBuilder<'a, 'b> {
    instruction: Box<CommissionSplFromSwapCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CommissionSplFromSwapCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CommissionSplFromSwapCpiBuilderInstruction {
            __program: program,
            payer: None,
    ...
    pub fn commission_token_account(
        &mut self,
        commission_token_account: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(
        ...
        let instruction = CommissionSplFromSwapCpi {
...
#[derive(Clone, Debug)]
struct CommissionSplFromSwapCpiBuilderInstruction<'a, 'b> {
    ...
    commission_token_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    args: Option<SwapArgs>,
    commission_rate: Option<u16>,
    bridge_to_args: Option<BridgeToArgs>,
    offset: Option<u8>,
