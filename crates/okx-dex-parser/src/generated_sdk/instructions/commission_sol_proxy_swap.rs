...
pub struct CommissionSolProxySwap {
    ...
    pub sa_authority: solana_program::pubkey::Pubkey,

    pub source_token_sa: Option<solana_program::pubkey::Pubkey>,

    pub destination_token_sa: Option<solana_program::pubkey::Pubkey>,
...
impl CommissionSolProxySwap {
    pub fn instruction(
        &self,
        args: CommissionSolProxySwapInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&CommissionSolProxySwapInstructionData::new()).unwrap();
...
pub struct CommissionSolProxySwapInstructionData {
    discriminator: [u8; 8],
}

impl CommissionSolProxySwapInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for CommissionSolProxySwapInstructionData {
...
/// Instruction builder for `CommissionSolProxySwap`.
///
/// ### Accounts:
///
...
///   9. `[]` source_token_program
///   10. `[]` destination_token_program
...
pub struct CommissionSolProxySwapBuilder {
    ...
    sa_authority: Option<solana_program::pubkey::Pubkey>,
    source_token_sa: Option<solana_program::pubkey::Pubkey>,
    destination_token_sa: Option<solana_program::pubkey::Pubkey>,
...
impl CommissionSolProxySwapBuilder {
    ...
    #[inline(always)]
    pub fn sa_authority(&mut self, sa_authority: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CommissionSolProxySwap {
            ...
            sa_authority: self.sa_authority.expect("sa_authority is not set"),
        ...
        let args = CommissionSolProxySwapInstructionArgs {
...
/// `commission_sol_proxy_swap` CPI accounts.
pub struct CommissionSolProxySwapCpiAccounts<'a, 'b> {
    ...
    pub sa_authority: &'b solana_program::account_info::AccountInfo<'a>,

    pub source_token_sa: Option<&'b solana_program::account_info::AccountInfo<'a>>,

    pub destination_token_sa: Option<&'b solana_program::account_info::AccountInfo<'a>>,
...
/// `commission_sol_proxy_swap` CPI instruction.
pub struct CommissionSolProxySwapCpi<'a, 'b> {
    ...
    pub __args: CommissionSolProxySwapInstructionArgs,
}

impl<'a, 'b> CommissionSolProxySwapCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CommissionSolProxySwapCpiAccounts<'a, 'b>,
        args: CommissionSolProxySwapInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CommissionSolProxySwap` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   12. `[]` system_program
#[derive(Clone, Debug)]
pub struct CommissionSolProxySwapCpiBuilder<'a, 'b> {
    instruction: Box<CommissionSolProxySwapCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CommissionSolProxySwapCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CommissionSolProxySwapCpiBuilderInstruction {
            __program: program,
            payer: None,
    ...
    pub fn sa_authority(
        &mut self,
        sa_authority: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn source_token_sa(
        &mut self,
        source_token_sa: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    ) -> &mut Self {
    ...
    pub fn destination_token_sa(
        &mut self,
        destination_token_sa: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(
        ...
        let instruction = CommissionSolProxySwapCpi {
...
#[derive(Clone, Debug)]
struct CommissionSolProxySwapCpiBuilderInstruction<'a, 'b> {
    ...
    sa_authority: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    source_token_sa: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    destination_token_sa: Option<&'b solana_program::account_info::AccountInfo<'a>>,
