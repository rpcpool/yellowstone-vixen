...
impl FromSwapLog {
    pub fn instruction(
        &self,
        args: FromSwapLogInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&FromSwapLogInstructionData::new()).unwrap();
...
pub struct FromSwapLogInstructionData {
    discriminator: [u8; 8],
}

impl FromSwapLogInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for FromSwapLogInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct FromSwapLogInstructionArgs {
    pub args: SwapArgs,
...
/// Instruction builder for `FromSwapLog`.
///
/// ### Accounts:
///
...
impl FromSwapLogBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = FromSwapLogInstructionArgs {
...
/// `from_swap_log` CPI accounts.
pub struct FromSwapLogCpiAccounts<'a, 'b> {
...
/// `from_swap_log` CPI instruction.
pub struct FromSwapLogCpi<'a, 'b> {
    ...
    pub __args: FromSwapLogInstructionArgs,
}

impl<'a, 'b> FromSwapLogCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: FromSwapLogCpiAccounts<'a, 'b>,
        args: FromSwapLogInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `FromSwapLog` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   9. `[]` system_program
#[derive(Clone, Debug)]
pub struct FromSwapLogCpiBuilder<'a, 'b> {
    instruction: Box<FromSwapLogCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> FromSwapLogCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(FromSwapLogCpiBuilderInstruction {
            __program: program,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = FromSwapLogCpi {
...
#[derive(Clone, Debug)]
struct FromSwapLogCpiBuilderInstruction<'a, 'b> {
