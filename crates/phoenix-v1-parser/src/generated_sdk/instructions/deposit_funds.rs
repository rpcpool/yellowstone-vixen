...
impl DepositFunds {
  pub fn instruction(&self, args: DepositFundsInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DepositFundsInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&DepositFundsInstructionData::new()).unwrap();
...
impl Default for DepositFundsInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
pub struct DepositFundsBuilder {
            phoenix_program: Option<solana_program::pubkey::Pubkey>,
                ...
                token_program: Option<solana_program::pubkey::Pubkey>,
                        quote_lots_to_deposit: Option<u64>,
                base_lots_to_deposit: Option<u64>,
...
#[inline(always)]
    pub fn token_program(&mut self, token_program: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn quote_lots_to_deposit(&mut self, quote_lots_to_deposit: u64) -> &mut Self {
        self.quote_lots_to_deposit = Some(quote_lots_to_deposit);
        self
      }
                #[inline(always)]
      pub fn base_lots_to_deposit(&mut self, base_lots_to_deposit: u64) -> &mut Self {
        self.base_lots_to_deposit = Some(base_lots_to_deposit);
        self
      }
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = DepositFunds {
          ...
          let args = DepositFundsInstructionArgs {
                                                              quote_lots_to_deposit: self.quote_lots_to_deposit.clone().expect("quote_lots_to_deposit is not set"),
                                                                  base_lots_to_deposit: self.base_lots_to_deposit.clone().expect("base_lots_to_deposit is not set"),
                                    };
  ...
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(DepositFundsCpiBuilderInstruction {
      __program: program,
              ...
              quote_vault: None,
              token_program: None,
                                            quote_lots_to_deposit: None,
                                base_lots_to_deposit: None,
...
#[inline(always)]
    pub fn token_program(&mut self, token_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn quote_lots_to_deposit(&mut self, quote_lots_to_deposit: u64) -> &mut Self {
        self.instruction.quote_lots_to_deposit = Some(quote_lots_to_deposit);
        self
      }
                #[inline(always)]
      pub fn base_lots_to_deposit(&mut self, base_lots_to_deposit: u64) -> &mut Self {
        self.instruction.base_lots_to_deposit = Some(base_lots_to_deposit);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = DepositFundsInstructionArgs {
                                                              quote_lots_to_deposit: self.instruction.quote_lots_to_deposit.clone().expect("quote_lots_to_deposit is not set"),
                                                                  base_lots_to_deposit: self.instruction.base_lots_to_deposit.clone().expect("base_lots_to_deposit is not set"),
                                    };
