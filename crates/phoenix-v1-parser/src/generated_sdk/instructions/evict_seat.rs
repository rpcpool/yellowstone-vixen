...
impl EvictSeat {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = borsh::to_vec(&EvictSeatInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct EvictSeatInstructionData {
            discriminator: u8,
      }

impl EvictSeatInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 106,
                  }
...
impl Default for EvictSeatInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `EvictSeat`.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
...
#[inline(always)]
  ...
  /// `evict_seat` CPI accounts.
  pub struct EvictSeatCpiAccounts<'a, 'b> {
                  /// Phoenix program
...
/// `evict_seat` CPI instruction.
pub struct EvictSeatCpi<'a, 'b> {
...
impl<'a, 'b> EvictSeatCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: EvictSeatCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `EvictSeat` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ...
          ///   10. `[]` token_program
#[derive(Clone, Debug)]
pub struct EvictSeatCpiBuilder<'a, 'b> {
  instruction: Box<EvictSeatCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> EvictSeatCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(EvictSeatCpiBuilderInstruction {
      __program: program,
...
#[derive(Clone, Debug)]
struct EvictSeatCpiBuilderInstruction<'a, 'b> {
