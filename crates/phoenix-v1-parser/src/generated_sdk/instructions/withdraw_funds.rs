...
#[inline(always)]
    pub fn token_program(&mut self, token_program: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    /// `[optional argument]`
#[inline(always)]
      pub fn quote_lots_to_withdraw(&mut self, quote_lots_to_withdraw: u64) -> &mut Self {
        self.quote_lots_to_withdraw = Some(quote_lots_to_withdraw);
        self
      }
                /// `[optional argument]`
#[inline(always)]
      pub fn base_lots_to_withdraw(&mut self, base_lots_to_withdraw: u64) -> &mut Self {
        self.base_lots_to_withdraw = Some(base_lots_to_withdraw);
        self
      }
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = WithdrawFunds {
          ...
          let args = WithdrawFundsInstructionArgs {
                                                              quote_lots_to_withdraw: self.quote_lots_to_withdraw.clone(),
                                                                  base_lots_to_withdraw: self.base_lots_to_withdraw.clone(),
                                    };
...
#[inline(always)]
      pub fn quote_lots_to_withdraw(&mut self, quote_lots_to_withdraw: u64) -> &mut Self {
        self.instruction.quote_lots_to_withdraw = Some(quote_lots_to_withdraw);
        self
      }
                /// `[optional argument]`
#[inline(always)]
      pub fn base_lots_to_withdraw(&mut self, base_lots_to_withdraw: u64) -> &mut Self {
        self.instruction.base_lots_to_withdraw = Some(base_lots_to_withdraw);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = WithdrawFundsInstructionArgs {
                                                              quote_lots_to_withdraw: self.instruction.quote_lots_to_withdraw.clone(),
                                                                  base_lots_to_withdraw: self.instruction.base_lots_to_withdraw.clone(),
                                    };
