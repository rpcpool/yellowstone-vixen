...
impl SwapWithFreeFunds {
  pub fn instruction(&self, args: SwapWithFreeFundsInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SwapWithFreeFundsInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&SwapWithFreeFundsInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SwapWithFreeFundsInstructionData {
            discriminator: u8,
            }

impl SwapWithFreeFundsInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 1,
                                }
...
impl Default for SwapWithFreeFundsInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct SwapWithFreeFundsInstructionArgs {
                  pub order_packet: OrderPacket,
      }


/// Instruction builder for `SwapWithFreeFunds`.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
...
pub struct SwapWithFreeFundsBuilder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SwapWithFreeFunds {
          ...
          let args = SwapWithFreeFundsInstructionArgs {
  ...
  /// `swap_with_free_funds` CPI accounts.
  pub struct SwapWithFreeFundsCpiAccounts<'a, 'b> {
                  /// Phoenix program
...
/// `swap_with_free_funds` CPI instruction.
pub struct SwapWithFreeFundsCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: SwapWithFreeFundsInstructionArgs,
  }

impl<'a, 'b> SwapWithFreeFundsCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: SwapWithFreeFundsCpiAccounts<'a, 'b>,
...
/// Instruction builder for `SwapWithFreeFunds` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ...
          ///   4. `[]` seat
#[derive(Clone, Debug)]
pub struct SwapWithFreeFundsCpiBuilder<'a, 'b> {
  instruction: Box<SwapWithFreeFundsCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SwapWithFreeFundsCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SwapWithFreeFundsCpiBuilderInstruction {
      __program: program,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = SwapWithFreeFundsCpi {
...
#[derive(Clone, Debug)]
struct SwapWithFreeFundsCpiBuilderInstruction<'a, 'b> {
