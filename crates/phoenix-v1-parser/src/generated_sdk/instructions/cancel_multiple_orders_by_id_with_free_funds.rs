...
impl CancelMultipleOrdersByIdWithFreeFunds {
  pub fn instruction(&self, args: CancelMultipleOrdersByIdWithFreeFundsInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CancelMultipleOrdersByIdWithFreeFundsInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&CancelMultipleOrdersByIdWithFreeFundsInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CancelMultipleOrdersByIdWithFreeFundsInstructionData {
            discriminator: u8,
            }

impl CancelMultipleOrdersByIdWithFreeFundsInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 11,
                                }
...
impl Default for CancelMultipleOrdersByIdWithFreeFundsInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CancelMultipleOrdersByIdWithFreeFundsInstructionArgs {
                  pub params: CancelMultipleOrdersByIdParams,
      }


/// Instruction builder for `CancelMultipleOrdersByIdWithFreeFunds`.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
...
pub struct CancelMultipleOrdersByIdWithFreeFundsBuilder {
...
impl CancelMultipleOrdersByIdWithFreeFundsBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            /// Phoenix program
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = CancelMultipleOrdersByIdWithFreeFunds {
          ...
          let args = CancelMultipleOrdersByIdWithFreeFundsInstructionArgs {
  ...
  /// `cancel_multiple_orders_by_id_with_free_funds` CPI accounts.
  pub struct CancelMultipleOrdersByIdWithFreeFundsCpiAccounts<'a, 'b> {
                  /// Phoenix program
...
/// `cancel_multiple_orders_by_id_with_free_funds` CPI instruction.
pub struct CancelMultipleOrdersByIdWithFreeFundsCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: CancelMultipleOrdersByIdWithFreeFundsInstructionArgs,
  }

impl<'a, 'b> CancelMultipleOrdersByIdWithFreeFundsCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: CancelMultipleOrdersByIdWithFreeFundsCpiAccounts<'a, 'b>,
...
/// Instruction builder for `CancelMultipleOrdersByIdWithFreeFunds` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ///   1. `[]` log_authority
                ...
                ///   3. `[signer]` trader
#[derive(Clone, Debug)]
pub struct CancelMultipleOrdersByIdWithFreeFundsCpiBuilder<'a, 'b> {
  instruction: Box<CancelMultipleOrdersByIdWithFreeFundsCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CancelMultipleOrdersByIdWithFreeFundsCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(CancelMultipleOrdersByIdWithFreeFundsCpiBuilderInstruction {
      __program: program,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = CancelMultipleOrdersByIdWithFreeFundsCpi {
...
#[derive(Clone, Debug)]
struct CancelMultipleOrdersByIdWithFreeFundsCpiBuilderInstruction<'a, 'b> {
