...
impl PlaceMultiplePostOnlyOrders {
  pub fn instruction(&self, args: PlaceMultiplePostOnlyOrdersInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: PlaceMultiplePostOnlyOrdersInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&PlaceMultiplePostOnlyOrdersInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct PlaceMultiplePostOnlyOrdersInstructionData {
            discriminator: u8,
            }

impl PlaceMultiplePostOnlyOrdersInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 16,
                                }
...
impl Default for PlaceMultiplePostOnlyOrdersInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct PlaceMultiplePostOnlyOrdersInstructionArgs {
                  pub multiple_order_packet: MultipleOrderPacket,
      }


/// Instruction builder for `PlaceMultiplePostOnlyOrders`.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
...
pub struct PlaceMultiplePostOnlyOrdersBuilder {
...
impl PlaceMultiplePostOnlyOrdersBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            /// Phoenix program
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = PlaceMultiplePostOnlyOrders {
          ...
          let args = PlaceMultiplePostOnlyOrdersInstructionArgs {
  ...
  /// `place_multiple_post_only_orders` CPI accounts.
  pub struct PlaceMultiplePostOnlyOrdersCpiAccounts<'a, 'b> {
                  /// Phoenix program
...
/// `place_multiple_post_only_orders` CPI instruction.
pub struct PlaceMultiplePostOnlyOrdersCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: PlaceMultiplePostOnlyOrdersInstructionArgs,
  }

impl<'a, 'b> PlaceMultiplePostOnlyOrdersCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: PlaceMultiplePostOnlyOrdersCpiAccounts<'a, 'b>,
...
/// Instruction builder for `PlaceMultiplePostOnlyOrders` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ...
          ///   9. `[]` token_program
#[derive(Clone, Debug)]
pub struct PlaceMultiplePostOnlyOrdersCpiBuilder<'a, 'b> {
  instruction: Box<PlaceMultiplePostOnlyOrdersCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PlaceMultiplePostOnlyOrdersCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(PlaceMultiplePostOnlyOrdersCpiBuilderInstruction {
      __program: program,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = PlaceMultiplePostOnlyOrdersCpi {
...
#[derive(Clone, Debug)]
struct PlaceMultiplePostOnlyOrdersCpiBuilderInstruction<'a, 'b> {
