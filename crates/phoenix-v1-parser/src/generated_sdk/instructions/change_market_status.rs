...
impl ChangeMarketStatus {
  pub fn instruction(&self, args: ChangeMarketStatusInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ChangeMarketStatusInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&ChangeMarketStatusInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ChangeMarketStatusInstructionData {
            discriminator: u8,
            }

impl ChangeMarketStatusInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 103,
                                }
...
impl Default for ChangeMarketStatusInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ChangeMarketStatusInstructionArgs {
                  pub market_status: MarketStatus,
      }


/// Instruction builder for `ChangeMarketStatus`.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
...
pub struct ChangeMarketStatusBuilder {
...
impl ChangeMarketStatusBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            /// Phoenix program
...
#[inline(always)]
    pub fn market_authority(&mut self, market_authority: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn market_status(&mut self, market_status: MarketStatus) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = ChangeMarketStatus {
          ...
          let args = ChangeMarketStatusInstructionArgs {
                                                              market_status: self.market_status.clone().expect("market_status is not set"),
                                    };
  ...
  /// `change_market_status` CPI accounts.
  pub struct ChangeMarketStatusCpiAccounts<'a, 'b> {
                  /// Phoenix program
...
/// `change_market_status` CPI instruction.
pub struct ChangeMarketStatusCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: ChangeMarketStatusInstructionArgs,
  }

impl<'a, 'b> ChangeMarketStatusCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: ChangeMarketStatusCpiAccounts<'a, 'b>,
...
/// Instruction builder for `ChangeMarketStatus` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ///   1. `[]` log_authority
                ...
                ///   3. `[signer]` market_authority
#[derive(Clone, Debug)]
pub struct ChangeMarketStatusCpiBuilder<'a, 'b> {
  instruction: Box<ChangeMarketStatusCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ChangeMarketStatusCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(ChangeMarketStatusCpiBuilderInstruction {
      __program: program,
...
#[inline(always)]
    pub fn market_authority(&mut self, market_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn market_status(&mut self, market_status: MarketStatus) -> &mut Self {
        self.instruction.market_status = Some(market_status);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = ChangeMarketStatusInstructionArgs {
                                                              market_status: self.instruction.market_status.clone().expect("market_status is not set"),
                                    };
        let instruction = ChangeMarketStatusCpi {
...
#[derive(Clone, Debug)]
struct ChangeMarketStatusCpiBuilderInstruction<'a, 'b> {
