...
pub struct ClaimAuthority {
          ...
          pub successor: solana_program::pubkey::Pubkey,
      }
...
impl ClaimAuthority {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = borsh::to_vec(&ClaimAuthorityInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ClaimAuthorityInstructionData {
            discriminator: u8,
      }

impl ClaimAuthorityInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 101,
                  }
...
impl Default for ClaimAuthorityInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `ClaimAuthority`.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
...
pub struct ClaimAuthorityBuilder {
            phoenix_program: Option<solana_program::pubkey::Pubkey>,
                ...
                successor: Option<solana_program::pubkey::Pubkey>,
                __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl ClaimAuthorityBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            /// Phoenix program
...
#[inline(always)]
    pub fn market(&mut self, market: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            /// The successor account must sign to claim authority
#[inline(always)]
    pub fn successor(&mut self, successor: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = ClaimAuthority {
                              phoenix_program: self.phoenix_program.expect("phoenix_program is not set"),
                                        ...
                                        successor: self.successor.expect("successor is not set"),
                      };
  ...
  /// `claim_authority` CPI accounts.
  pub struct ClaimAuthorityCpiAccounts<'a, 'b> {
                  /// Phoenix program
              ...
              pub successor: &'b solana_program::account_info::AccountInfo<'a>,
            }

/// `claim_authority` CPI instruction.
pub struct ClaimAuthorityCpi<'a, 'b> {
...
impl<'a, 'b> ClaimAuthorityCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: ClaimAuthorityCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
  ...
  pub fn invoke_signed_with_remaining_accounts(
    ...
    account_infos.push(self.__program.clone());
                  account_infos.push(self.phoenix_program.clone());
                        ...
                        account_infos.push(self.successor.clone());
...
/// Instruction builder for `ClaimAuthority` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ///   1. `[]` log_authority
                ...
                ///   3. `[signer]` successor
#[derive(Clone, Debug)]
pub struct ClaimAuthorityCpiBuilder<'a, 'b> {
  instruction: Box<ClaimAuthorityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ClaimAuthorityCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(ClaimAuthorityCpiBuilderInstruction {
      __program: program,
...
#[inline(always)]
    pub fn market(&mut self, market: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// The successor account must sign to claim authority
#[inline(always)]
    pub fn successor(&mut self, successor: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        let instruction = ClaimAuthorityCpi {
        __program: self.instruction.__program,
          ...
          successor: self.instruction.successor.expect("successor is not set"),
                    };
...
#[derive(Clone, Debug)]
struct ClaimAuthorityCpiBuilderInstruction<'a, 'b> {
  __program: &'b solana_program::account_info::AccountInfo<'a>,
            phoenix_program: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                ...
                successor: Option<&'b solana_program::account_info::AccountInfo<'a>>,
