...
impl NameSuccessor {
  pub fn instruction(&self, args: NameSuccessorInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: NameSuccessorInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&NameSuccessorInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct NameSuccessorInstructionData {
            discriminator: u8,
            }

impl NameSuccessorInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 102,
                                }
...
impl Default for NameSuccessorInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct NameSuccessorInstructionArgs {
                  pub successor: Pubkey,
      }


/// Instruction builder for `NameSuccessor`.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
...
pub struct NameSuccessorBuilder {
...
#[inline(always)]
    pub fn market_authority(&mut self, market_authority: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn successor(&mut self, successor: Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = NameSuccessor {
          ...
          let args = NameSuccessorInstructionArgs {
                                                              successor: self.successor.clone().expect("successor is not set"),
                                    };
  ...
  /// `name_successor` CPI accounts.
  pub struct NameSuccessorCpiAccounts<'a, 'b> {
                  /// Phoenix program
...
/// `name_successor` CPI instruction.
pub struct NameSuccessorCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: NameSuccessorInstructionArgs,
  }

impl<'a, 'b> NameSuccessorCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: NameSuccessorCpiAccounts<'a, 'b>,
              args: NameSuccessorInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `NameSuccessor` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ///   1. `[]` log_authority
                ...
                ///   3. `[signer]` market_authority
#[derive(Clone, Debug)]
pub struct NameSuccessorCpiBuilder<'a, 'b> {
  instruction: Box<NameSuccessorCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> NameSuccessorCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(NameSuccessorCpiBuilderInstruction {
      __program: program,
...
#[inline(always)]
    pub fn market_authority(&mut self, market_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn successor(&mut self, successor: Pubkey) -> &mut Self {
        self.instruction.successor = Some(successor);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = NameSuccessorInstructionArgs {
                                                              successor: self.instruction.successor.clone().expect("successor is not set"),
                                    };
        let instruction = NameSuccessorCpi {
...
#[derive(Clone, Debug)]
struct NameSuccessorCpiBuilderInstruction<'a, 'b> {
