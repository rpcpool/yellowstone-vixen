...
use crate::generated::types::ReduceOrderParams;
...
impl ReduceOrderWithFreeFunds {
  pub fn instruction(&self, args: ReduceOrderWithFreeFundsInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ReduceOrderWithFreeFundsInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&ReduceOrderWithFreeFundsInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ReduceOrderWithFreeFundsInstructionData {
            discriminator: u8,
            }

impl ReduceOrderWithFreeFundsInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 5,
                                }
...
impl Default for ReduceOrderWithFreeFundsInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ReduceOrderWithFreeFundsInstructionArgs {
                  pub params: ReduceOrderParams,
      }


/// Instruction builder for `ReduceOrderWithFreeFunds`.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ///   1. `[]` log_authority
                ///   2. `[writable]` market
                      ///   3. `[writable, signer]` trader
#[derive(Clone, Debug, Default)]
pub struct ReduceOrderWithFreeFundsBuilder {
            phoenix_program: Option<solana_program::pubkey::Pubkey>,
                ...
                trader: Option<solana_program::pubkey::Pubkey>,
                        params: Option<ReduceOrderParams>,
        __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl ReduceOrderWithFreeFundsBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            /// Phoenix program
...
#[inline(always)]
    ...
    pub fn trader(&mut self, trader: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn params(&mut self, params: ReduceOrderParams) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = ReduceOrderWithFreeFunds {
          ...
          let args = ReduceOrderWithFreeFundsInstructionArgs {
  ...
  /// `reduce_order_with_free_funds` CPI accounts.
  pub struct ReduceOrderWithFreeFundsCpiAccounts<'a, 'b> {
                  /// Phoenix program
...
/// `reduce_order_with_free_funds` CPI instruction.
pub struct ReduceOrderWithFreeFundsCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: ReduceOrderWithFreeFundsInstructionArgs,
  }

impl<'a, 'b> ReduceOrderWithFreeFundsCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: ReduceOrderWithFreeFundsCpiAccounts<'a, 'b>,
...
/// Instruction builder for `ReduceOrderWithFreeFunds` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ///   1. `[]` log_authority
                ///   2. `[writable]` market
                      ///   3. `[writable, signer]` trader
#[derive(Clone, Debug)]
pub struct ReduceOrderWithFreeFundsCpiBuilder<'a, 'b> {
  instruction: Box<ReduceOrderWithFreeFundsCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ReduceOrderWithFreeFundsCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(ReduceOrderWithFreeFundsCpiBuilderInstruction {
      __program: program,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = ReduceOrderWithFreeFundsCpi {
...
#[derive(Clone, Debug)]
struct ReduceOrderWithFreeFundsCpiBuilderInstruction<'a, 'b> {
