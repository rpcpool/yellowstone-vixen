...
use crate::generated::types::SeatApprovalStatus;
...
impl ChangeSeatStatus {
  pub fn instruction(&self, args: ChangeSeatStatusInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ChangeSeatStatusInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&ChangeSeatStatusInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ChangeSeatStatusInstructionData {
            discriminator: u8,
            }

impl ChangeSeatStatusInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 104,
                                }
...
impl Default for ChangeSeatStatusInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ChangeSeatStatusInstructionArgs {
                  pub approval_status: SeatApprovalStatus,
      }


/// Instruction builder for `ChangeSeatStatus`.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
...
pub struct ChangeSeatStatusBuilder {
            phoenix_program: Option<solana_program::pubkey::Pubkey>,
                ...
                seat: Option<solana_program::pubkey::Pubkey>,
                        approval_status: Option<SeatApprovalStatus>,
        __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl ChangeSeatStatusBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            /// Phoenix program
...
#[inline(always)]
    ...
    pub fn seat(&mut self, seat: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn approval_status(&mut self, approval_status: SeatApprovalStatus) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = ChangeSeatStatus {
          ...
          let args = ChangeSeatStatusInstructionArgs {
                                                              approval_status: self.approval_status.clone().expect("approval_status is not set"),
                                    };
  ...
  /// `change_seat_status` CPI accounts.
  pub struct ChangeSeatStatusCpiAccounts<'a, 'b> {
                  /// Phoenix program
...
/// `change_seat_status` CPI instruction.
pub struct ChangeSeatStatusCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: ChangeSeatStatusInstructionArgs,
  }

impl<'a, 'b> ChangeSeatStatusCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: ChangeSeatStatusCpiAccounts<'a, 'b>,
              args: ChangeSeatStatusInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `ChangeSeatStatus` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ///   1. `[]` log_authority
                ...
                ///   4. `[writable]` seat
#[derive(Clone, Debug)]
pub struct ChangeSeatStatusCpiBuilder<'a, 'b> {
  instruction: Box<ChangeSeatStatusCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ChangeSeatStatusCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(ChangeSeatStatusCpiBuilderInstruction {
      __program: program,
...
#[inline(always)]
    ...
    pub fn seat(&mut self, seat: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn approval_status(&mut self, approval_status: SeatApprovalStatus) -> &mut Self {
        self.instruction.approval_status = Some(approval_status);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = ChangeSeatStatusInstructionArgs {
                                                              approval_status: self.instruction.approval_status.clone().expect("approval_status is not set"),
                                    };
        let instruction = ChangeSeatStatusCpi {
...
#[derive(Clone, Debug)]
struct ChangeSeatStatusCpiBuilderInstruction<'a, 'b> {
