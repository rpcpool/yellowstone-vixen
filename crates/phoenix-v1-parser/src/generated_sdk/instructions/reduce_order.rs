...
impl ReduceOrder {
  pub fn instruction(&self, args: ReduceOrderInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ReduceOrderInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&ReduceOrderInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ReduceOrderInstructionData {
            discriminator: u8,
            }

impl ReduceOrderInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 4,
                                }
...
impl Default for ReduceOrderInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ReduceOrderInstructionArgs {
                  pub params: ReduceOrderParams,
      }


/// Instruction builder for `ReduceOrder`.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = ReduceOrder {
          ...
          let args = ReduceOrderInstructionArgs {
  ...
  /// `reduce_order` CPI accounts.
  pub struct ReduceOrderCpiAccounts<'a, 'b> {
                  /// Phoenix program
...
/// `reduce_order` CPI instruction.
pub struct ReduceOrderCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: ReduceOrderInstructionArgs,
  }

impl<'a, 'b> ReduceOrderCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: ReduceOrderCpiAccounts<'a, 'b>,
...
/// Instruction builder for `ReduceOrder` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ...
          ///   8. `[]` token_program
#[derive(Clone, Debug)]
pub struct ReduceOrderCpiBuilder<'a, 'b> {
  instruction: Box<ReduceOrderCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ReduceOrderCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(ReduceOrderCpiBuilderInstruction {
      __program: program,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = ReduceOrderCpi {
...
#[derive(Clone, Debug)]
struct ReduceOrderCpiBuilderInstruction<'a, 'b> {
