...
impl RequestSeat {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = borsh::to_vec(&RequestSeatInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct RequestSeatInstructionData {
            discriminator: u8,
      }

impl RequestSeatInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 14,
                  }
...
impl Default for RequestSeatInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `RequestSeat`.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
...
#[inline(always)]
  ...
  /// `request_seat` CPI accounts.
  pub struct RequestSeatCpiAccounts<'a, 'b> {
                  /// Phoenix program
...
/// `request_seat` CPI instruction.
pub struct RequestSeatCpi<'a, 'b> {
...
impl<'a, 'b> RequestSeatCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: RequestSeatCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `RequestSeat` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ...
          ///   5. `[]` system_program
#[derive(Clone, Debug)]
pub struct RequestSeatCpiBuilder<'a, 'b> {
  instruction: Box<RequestSeatCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RequestSeatCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(RequestSeatCpiBuilderInstruction {
      __program: program,
...
#[inline(always)]
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        let instruction = RequestSeatCpi {
...
#[derive(Clone, Debug)]
struct RequestSeatCpiBuilderInstruction<'a, 'b> {
