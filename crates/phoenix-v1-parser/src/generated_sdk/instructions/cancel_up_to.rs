...
impl CancelUpTo {
  pub fn instruction(&self, args: CancelUpToInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CancelUpToInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&CancelUpToInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CancelUpToInstructionData {
            discriminator: u8,
            }

impl CancelUpToInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 8,
                                }
...
impl Default for CancelUpToInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CancelUpToInstructionArgs {
                  pub params: CancelUpToParams,
      }


/// Instruction builder for `CancelUpTo`.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = CancelUpTo {
          ...
          let args = CancelUpToInstructionArgs {
  ...
  /// `cancel_up_to` CPI accounts.
  pub struct CancelUpToCpiAccounts<'a, 'b> {
                  /// Phoenix program
...
/// `cancel_up_to` CPI instruction.
pub struct CancelUpToCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: CancelUpToInstructionArgs,
  }

impl<'a, 'b> CancelUpToCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: CancelUpToCpiAccounts<'a, 'b>,
...
/// Instruction builder for `CancelUpTo` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` phoenix_program
          ...
          ///   8. `[]` token_program
#[derive(Clone, Debug)]
pub struct CancelUpToCpiBuilder<'a, 'b> {
  instruction: Box<CancelUpToCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CancelUpToCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(CancelUpToCpiBuilderInstruction {
      __program: program,
...
#[derive(Clone, Debug)]
struct CancelUpToCpiBuilderInstruction<'a, 'b> {
