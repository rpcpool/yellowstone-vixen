...
impl SwapBaseOut {
  pub fn instruction(&self, args: SwapBaseOutInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SwapBaseOutInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
#[inline(always)]
    ...
    pub fn serum_vault_signer(&mut self, serum_vault_signer: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn uer_source_token_account(&mut self, uer_source_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.uer_source_token_account = Some(uer_source_token_account);
                    self
    }
            #[inline(always)]
    pub fn uer_destination_token_account(&mut self, uer_destination_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.uer_destination_token_account = Some(uer_destination_token_account);
                    self
    }
            #[inline(always)]
    pub fn user_source_owner(&mut self, user_source_owner: solana_program::pubkey::Pubkey) -> &mut Self {
...
impl<'a, 'b> SwapBaseOutCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn serum_vault_signer(&mut self, serum_vault_signer: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn uer_source_token_account(&mut self, uer_source_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.uer_source_token_account = Some(uer_source_token_account);
                    self
    }
      #[inline(always)]
    pub fn uer_destination_token_account(&mut self, uer_destination_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.uer_destination_token_account = Some(uer_destination_token_account);
                    self
    }
      #[inline(always)]
    pub fn user_source_owner(&mut self, user_source_owner: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
