...
#[inline(always)]
    ...
    pub fn serum_event_queue(&mut self, serum_event_queue: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn serum_coin_vault(&mut self, serum_coin_vault: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn serum_vault_signer(&mut self, serum_vault_signer: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn new_amm_open_orders(&mut self, new_amm_open_orders: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.new_amm_open_orders = Some(new_amm_open_orders);
                    self
    }
            #[inline(always)]
    pub fn new_serum_program(&mut self, new_serum_program: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.new_serum_program = Some(new_serum_program);
                    self
    }
            #[inline(always)]
    pub fn new_serum_market(&mut self, new_serum_market: solana_program::pubkey::Pubkey) -> &mut Self {
...
impl<'a, 'b> MigrateToOpenBookCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn amm_open_orders(&mut self, amm_open_orders: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn amm_token_coin(&mut self, amm_token_coin: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.amm_token_coin = Some(amm_token_coin);
                    self
    }
      #[inline(always)]
    pub fn amm_token_pc(&mut self, amm_token_pc: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn serum_event_queue(&mut self, serum_event_queue: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn serum_coin_vault(&mut self, serum_coin_vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.serum_coin_vault = Some(serum_coin_vault);
                    self
    }
      #[inline(always)]
    pub fn serum_pc_vault(&mut self, serum_pc_vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn serum_vault_signer(&mut self, serum_vault_signer: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn new_amm_open_orders(&mut self, new_amm_open_orders: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.new_amm_open_orders = Some(new_amm_open_orders);
                    self
    }
      #[inline(always)]
    pub fn new_serum_program(&mut self, new_serum_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.new_serum_program = Some(new_serum_program);
                    self
    }
      #[inline(always)]
    pub fn new_serum_market(&mut self, new_serum_market: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
