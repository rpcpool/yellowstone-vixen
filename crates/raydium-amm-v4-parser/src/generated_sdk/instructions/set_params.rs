...
#[inline(always)]
    ...
    pub fn serum_asks(&mut self, serum_asks: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn amm_admin_account(&mut self, amm_admin_account: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = SetParams {
                              token_program: self.token_program.unwrap_or(solana_program::pubkey!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA")),
                                        ...
                                        amm_admin_account: self.amm_admin_account.expect("amm_admin_account is not set"),
                      };
...
impl<'a, 'b> SetParamsCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn amm_target_orders(&mut self, amm_target_orders: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn amm_coin_vault(&mut self, amm_coin_vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.amm_coin_vault = Some(amm_coin_vault);
                    self
    }
      #[inline(always)]
    pub fn amm_pc_vault(&mut self, amm_pc_vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn serum_asks(&mut self, serum_asks: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn amm_admin_account(&mut self, amm_admin_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          amm_coin_vault: self.instruction.amm_coin_vault.expect("amm_coin_vault is not set"),
                  
          amm_pc_vault: self.instruction.amm_pc_vault.expect("amm_pc_vault is not set"),
          ...
          amm_admin_account: self.instruction.amm_admin_account.expect("amm_admin_account is not set"),
                          __args: args,
            };
