...
#[inline(always)]
    ...
    pub fn amm_target_orders(&mut self, amm_target_orders: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn lp_mint_address(&mut self, lp_mint_address: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn pool_pc_token_account(&mut self, pool_pc_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn pool_withdraw_queue(&mut self, pool_withdraw_queue: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.pool_withdraw_queue = Some(pool_withdraw_queue);
                    self
    }
            #[inline(always)]
    pub fn pool_temp_lp_token_account(&mut self, pool_temp_lp_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn serum_vault_signer(&mut self, serum_vault_signer: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn user_lp_token_account(&mut self, user_lp_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.user_lp_token_account = Some(user_lp_token_account);
                    self
    }
            #[inline(always)]
    pub fn uer_coin_token_account(&mut self, uer_coin_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.uer_coin_token_account = Some(uer_coin_token_account);
                    self
    }
            #[inline(always)]
    pub fn uer_pc_token_account(&mut self, uer_pc_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
...
impl<'a, 'b> WithdrawCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn amm_target_orders(&mut self, amm_target_orders: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn lp_mint_address(&mut self, lp_mint_address: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn pool_pc_token_account(&mut self, pool_pc_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn pool_withdraw_queue(&mut self, pool_withdraw_queue: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pool_withdraw_queue = Some(pool_withdraw_queue);
                    self
    }
      #[inline(always)]
    pub fn pool_temp_lp_token_account(&mut self, pool_temp_lp_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn serum_vault_signer(&mut self, serum_vault_signer: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn user_lp_token_account(&mut self, user_lp_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_lp_token_account = Some(user_lp_token_account);
                    self
    }
      #[inline(always)]
    pub fn uer_coin_token_account(&mut self, uer_coin_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.uer_coin_token_account = Some(uer_coin_token_account);
                    self
    }
      #[inline(always)]
    pub fn uer_pc_token_account(&mut self, uer_pc_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.uer_pc_token_account = Some(uer_pc_token_account);
                    self
    }
      #[inline(always)]
    pub fn user_owner(&mut self, user_owner: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.user_owner = Some(user_owner);
                    self
    }
      #[inline(always)]
    pub fn serum_event_q(&mut self, serum_event_q: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.serum_event_q = Some(serum_event_q);
                    self
    }
      #[inline(always)]
    pub fn serum_bids(&mut self, serum_bids: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.serum_bids = Some(serum_bids);
                    self
    }
      #[inline(always)]
    pub fn serum_asks(&mut self, serum_asks: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
