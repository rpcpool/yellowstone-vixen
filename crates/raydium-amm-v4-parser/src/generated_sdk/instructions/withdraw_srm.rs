...
impl WithdrawSrm {
  pub fn instruction(&self, args: WithdrawSrmInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: WithdrawSrmInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
impl<'a, 'b> WithdrawSrmCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn amm_authority(&mut self, amm_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn srm_token(&mut self, srm_token: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.srm_token = Some(srm_token);
                    self
    }
      #[inline(always)]
    pub fn dest_srm_token(&mut self, dest_srm_token: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
