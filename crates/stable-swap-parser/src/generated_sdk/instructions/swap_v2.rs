...
pub struct SwapV2 {
    ...
    pub mint_in: solana_program::pubkey::Pubkey,

    pub mint_out: solana_program::pubkey::Pubkey,
...
///   5. `[writable]` vault_token_in
///   6. `[writable]` vault_token_out
///   7. `[writable]` beneficiary_token_out
///   8. `[writable]` pool
...
///   14. `[]` token2022_program
#[derive(Clone, Debug, Default)]
pub struct SwapV2Builder {
    user: Option<solana_program::pubkey::Pubkey>,
    mint_in: Option<solana_program::pubkey::Pubkey>,
    mint_out: Option<solana_program::pubkey::Pubkey>,
...
impl SwapV2Builder {
    ...
    #[inline(always)]
    pub fn mint_in(&mut self, mint_in: solana_program::pubkey::Pubkey) -> &mut Self {
        self.mint_in = Some(mint_in);
        self
    }

    #[inline(always)]
    pub fn mint_out(&mut self, mint_out: solana_program::pubkey::Pubkey) -> &mut Self {
        self.mint_out = Some(mint_out);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = SwapV2 {
            ...
            mint_in: self.mint_in.expect("mint_in is not set"),
            mint_out: self.mint_out.expect("mint_out is not set"),
...
pub struct SwapV2CpiAccounts<'a, 'b> {
    ...
    pub mint_in: &'b solana_program::account_info::AccountInfo<'a>,

    pub mint_out: &'b solana_program::account_info::AccountInfo<'a>,
...
impl<'a, 'b> SwapV2Cpi<'a, 'b> {
    pub fn new(
        ...
        Self {
            __program: program,
            user: accounts.user,
            mint_in: accounts.mint_in,
            mint_out: accounts.mint_out,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        account_infos.push(self.mint_in.clone());
        account_infos.push(self.mint_out.clone());
...
impl<'a, 'b> SwapV2CpiBuilder<'a, 'b> {
    ...
    pub fn mint_in(
        &mut self,
        mint_in: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.mint_in = Some(mint_in);
        self
    }
    ...
    pub fn mint_out(
        &mut self,
        mint_out: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.mint_out = Some(mint_out);
        self
    }
    ...
    pub fn invoke_signed(
        ...
        let instruction = SwapV2Cpi {
            ...
            mint_in: self.instruction.mint_in.expect("mint_in is not set"),

            mint_out: self.instruction.mint_out.expect("mint_out is not set"),
...
struct SwapV2CpiBuilderInstruction<'a, 'b> {
    ...
    mint_in: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    mint_out: Option<&'b solana_program::account_info::AccountInfo<'a>>,
