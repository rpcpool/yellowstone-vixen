...
pub struct Server<'a, S: SourceTrait, M: MetricsFactory> {
    grpc_cfg: GrpcConfig,
    desc_sets: Vec<&'a [u8]>,
    channels: Channels,
    runtime: Runtime<M, S>,
...
impl<S: SourceTrait, M: MetricsFactory + fmt::Debug> fmt::Debug for Server<'_, S, M>
where
