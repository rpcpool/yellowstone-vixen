...
impl RepayLoanV3Compressed {
    pub fn instruction(
        &self,
        args: RepayLoanV3CompressedInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&RepayLoanV3CompressedInstructionData::new()).unwrap();
...
pub struct RepayLoanV3CompressedInstructionData {
    discriminator: [u8; 8],
}

impl RepayLoanV3CompressedInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for RepayLoanV3CompressedInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct RepayLoanV3CompressedInstructionArgs {
    pub cnft_root: [u8; 32],
...
/// Instruction builder for `RepayLoanV3Compressed`.
///
/// ### Accounts:
///
///   0. `[writable]` loan
...
impl RepayLoanV3CompressedBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = RepayLoanV3Compressed {
        ...
        let args = RepayLoanV3CompressedInstructionArgs {
...
/// `repay_loan_v3_compressed` CPI accounts.
pub struct RepayLoanV3CompressedCpiAccounts<'a, 'b> {
...
/// `repay_loan_v3_compressed` CPI instruction.
pub struct RepayLoanV3CompressedCpi<'a, 'b> {
    ...
    pub __args: RepayLoanV3CompressedInstructionArgs,
}

impl<'a, 'b> RepayLoanV3CompressedCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: RepayLoanV3CompressedCpiAccounts<'a, 'b>,
        args: RepayLoanV3CompressedInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RepayLoanV3Compressed` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` loan
...
///   14. `[]` rent
#[derive(Clone, Debug)]
pub struct RepayLoanV3CompressedCpiBuilder<'a, 'b> {
    instruction: Box<RepayLoanV3CompressedCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RepayLoanV3CompressedCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RepayLoanV3CompressedCpiBuilderInstruction {
            __program: program,
            loan: None,
            borrower: None,
            lender: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = RepayLoanV3CompressedCpi {
...
#[derive(Clone, Debug)]
struct RepayLoanV3CompressedCpiBuilderInstruction<'a, 'b> {
