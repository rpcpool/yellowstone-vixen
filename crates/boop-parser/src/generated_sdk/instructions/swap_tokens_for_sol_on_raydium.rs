...
impl SwapTokensForSolOnRaydium {
    pub fn instruction(
        &self,
        args: SwapTokensForSolOnRaydiumInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&SwapTokensForSolOnRaydiumInstructionData::new()).unwrap();
...
pub struct SwapTokensForSolOnRaydiumInstructionData {
    discriminator: [u8; 8],
}

impl SwapTokensForSolOnRaydiumInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for SwapTokensForSolOnRaydiumInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapTokensForSolOnRaydiumInstructionArgs {
    pub amount_in: u64,
    pub minimum_amount_out: u64,
}

/// Instruction builder for `SwapTokensForSolOnRaydium`.
///
/// ### Accounts:
///
///   0. `[]` config
...
///   11. `[]` input_token_mint
///   12. `[optional]` output_token_mint (default to `So11111111111111111111111111111111111111112`)
...
pub struct SwapTokensForSolOnRaydiumBuilder {
...
impl SwapTokensForSolOnRaydiumBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = SwapTokensForSolOnRaydium {
            ...
            output_token_mint: self.output_token_mint.unwrap_or(solana_program::pubkey!(
        ...
        let args = SwapTokensForSolOnRaydiumInstructionArgs {
...
/// `swap_tokens_for_sol_on_raydium` CPI accounts.
pub struct SwapTokensForSolOnRaydiumCpiAccounts<'a, 'b> {
...
/// `swap_tokens_for_sol_on_raydium` CPI instruction.
pub struct SwapTokensForSolOnRaydiumCpi<'a, 'b> {
    ...
    pub __args: SwapTokensForSolOnRaydiumInstructionArgs,
}

impl<'a, 'b> SwapTokensForSolOnRaydiumCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: SwapTokensForSolOnRaydiumCpiAccounts<'a, 'b>,
        args: SwapTokensForSolOnRaydiumInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SwapTokensForSolOnRaydium` via CPI.
///
/// ### Accounts:
///
///   0. `[]` config
...
///   15. `[writable]` observation_state
#[derive(Clone, Debug)]
pub struct SwapTokensForSolOnRaydiumCpiBuilder<'a, 'b> {
    instruction: Box<SwapTokensForSolOnRaydiumCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SwapTokensForSolOnRaydiumCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SwapTokensForSolOnRaydiumCpiBuilderInstruction {
            __program: program,
            config: None,
            bonding_curve: None,
            amm_config: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = SwapTokensForSolOnRaydiumCpi {
...
#[derive(Clone, Debug)]
struct SwapTokensForSolOnRaydiumCpiBuilderInstruction<'a, 'b> {
