...
impl CreateTokenFallback {
    pub fn instruction(
        &self,
        args: CreateTokenFallbackInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&CreateTokenFallbackInstructionData::new()).unwrap();
...
pub struct CreateTokenFallbackInstructionData {
    discriminator: [u8; 8],
}

impl CreateTokenFallbackInstructionData {
    pub fn new() -> Self {
        Self {
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CreateTokenFallbackInstructionArgs {
    pub salt: u64,
    pub name: String,
    pub symbol: String,
    pub uri: String,
...
/// Instruction builder for `CreateTokenFallback`.
///
/// ### Accounts:
///
///   0. `[]` config
...
pub struct CreateTokenFallbackBuilder {
...
impl CreateTokenFallbackBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = CreateTokenFallbackInstructionArgs {
...
/// `create_token_fallback` CPI accounts.
pub struct CreateTokenFallbackCpiAccounts<'a, 'b> {
...
/// `create_token_fallback` CPI instruction.
pub struct CreateTokenFallbackCpi<'a, 'b> {
    ...
    pub __args: CreateTokenFallbackInstructionArgs,
}

impl<'a, 'b> CreateTokenFallbackCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CreateTokenFallbackCpiAccounts<'a, 'b>,
        args: CreateTokenFallbackInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CreateTokenFallback` via CPI.
///
/// ### Accounts:
///
///   0. `[]` config
...
#[derive(Clone, Debug)]
pub struct CreateTokenFallbackCpiBuilder<'a, 'b> {
    instruction: Box<CreateTokenFallbackCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CreateTokenFallbackCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CreateTokenFallbackCpiBuilderInstruction {
            __program: program,
            config: None,
            metadata: None,
            mint: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = CreateTokenFallbackCpi {
...
#[derive(Clone, Debug)]
struct CreateTokenFallbackCpiBuilderInstruction<'a, 'b> {
