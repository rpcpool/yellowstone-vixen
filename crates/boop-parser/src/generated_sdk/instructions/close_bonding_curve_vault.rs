...
pub struct CloseBondingCurveVaultInstructionData {
    discriminator: [u8; 8],
}

impl CloseBondingCurveVaultInstructionData {
    pub fn new() -> Self {
        Self {
...
/// Instruction builder for `CloseBondingCurveVault` via CPI.
///
/// ### Accounts:
///
///   0. `[]` config
...
///   11. `[]` rent
#[derive(Clone, Debug)]
pub struct CloseBondingCurveVaultCpiBuilder<'a, 'b> {
    instruction: Box<CloseBondingCurveVaultCpiBuilderInstruction<'a, 'b>>,
}
