...
pub struct AddRewards {
    ...
    pub payer_reward_token_ata: solana_program::pubkey::Pubkey,
...
impl AddRewards {
    pub fn instruction(
        &self,
        args: AddRewardsInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&AddRewardsInstructionData::new()).unwrap();
...
impl Default for AddRewardsInstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct AddRewardsInstructionArgs {
    pub amount: u64,
    pub reward_index: u64,
}

/// Instruction builder for `AddRewards`.
///
/// ### Accounts:
///
...
///   5. `[writable]` payer_reward_token_ata
///   6. `[optional]` scope_prices
///   7. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
#[derive(Clone, Debug, Default)]
pub struct AddRewardsBuilder {
    ...
    payer_reward_token_ata: Option<solana_program::pubkey::Pubkey>,
...
impl AddRewardsBuilder {
    ...
    #[inline(always)]
    pub fn payer_reward_token_ata(
        &mut self,
        payer_reward_token_ata: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
        self.payer_reward_token_ata = Some(payer_reward_token_ata);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = AddRewards {
            ...
            payer_reward_token_ata: self
                .payer_reward_token_ata
                .expect("payer_reward_token_ata is not set"),
            scope_prices: self.scope_prices,
            token_program: self.token_program.unwrap_or(solana_program::pubkey!(
                "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA"
            )),
        };
        let args = AddRewardsInstructionArgs {
...
/// `add_rewards` CPI accounts.
pub struct AddRewardsCpiAccounts<'a, 'b> {
    ...
    pub payer_reward_token_ata: &'b solana_program::account_info::AccountInfo<'a>,
...
/// `add_rewards` CPI instruction.
pub struct AddRewardsCpi<'a, 'b> {
    ...
    pub __args: AddRewardsInstructionArgs,
}

impl<'a, 'b> AddRewardsCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: AddRewardsCpiAccounts<'a, 'b>,
        args: AddRewardsInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
            ...
            payer_reward_token_ata: accounts.payer_reward_token_ata,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(
            *self.payer_reward_token_ata.key,
            false,
        ));
        if let Some(scope_prices) = self.scope_prices {
            accounts.push(solana_program::instruction::AccountMeta::new_readonly(
        ...
        account_infos.push(self.payer_reward_token_ata.clone());
        if let Some(scope_prices) = self.scope_prices {
...
/// Instruction builder for `AddRewards` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   7. `[]` token_program
#[derive(Clone, Debug)]
pub struct AddRewardsCpiBuilder<'a, 'b> {
    instruction: Box<AddRewardsCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddRewardsCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddRewardsCpiBuilderInstruction {
            __program: program,
            payer: None,
            farm_state: None,
            reward_mint: None,
    ...
    pub fn payer_reward_token_ata(
        &mut self,
        payer_reward_token_ata: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.payer_reward_token_ata = Some(payer_reward_token_ata);
        self
    }
...
#[derive(Clone, Debug)]
struct AddRewardsCpiBuilderInstruction<'a, 'b> {
    ...
    payer_reward_token_ata: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    scope_prices: Option<&'b solana_program::account_info::AccountInfo<'a>>,
