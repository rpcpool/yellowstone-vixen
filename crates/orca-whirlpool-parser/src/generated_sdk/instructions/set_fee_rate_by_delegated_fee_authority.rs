...
impl SetFeeRateByDelegatedFeeAuthority {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data =
            borsh::to_vec(&SetFeeRateByDelegatedFeeAuthorityInstructionData::new()).unwrap();
...
pub struct SetFeeRateByDelegatedFeeAuthorityBuilder {
    ...
    delegated_fee_authority: Option<solana_pubkey::Pubkey>,
    fee_rate: Option<u16>,
...
impl SetFeeRateByDelegatedFeeAuthorityBuilder {
    ...
    #[inline(always)]
    pub fn delegated_fee_authority(
        &mut self,
        delegated_fee_authority: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = SetFeeRateByDelegatedFeeAuthority {
            ...
            delegated_fee_authority: self
                .delegated_fee_authority
                .expect("delegated_fee_authority is not set"),
        };
...
impl<'a, 'b> SetFeeRateByDelegatedFeeAuthorityCpiBuilder<'a, 'b> {
    ...
    pub fn delegated_fee_authority(
        &mut self,
        delegated_fee_authority: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
