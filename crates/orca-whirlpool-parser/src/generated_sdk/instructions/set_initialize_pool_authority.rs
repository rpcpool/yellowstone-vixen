...
impl SetInitializePoolAuthorityBuilder {
    ...
    #[inline(always)]
    pub fn new_initialize_pool_authority(
        &mut self,
        new_initialize_pool_authority: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = SetInitializePoolAuthority {
            ...
            new_initialize_pool_authority: self
                .new_initialize_pool_authority
                .expect("new_initialize_pool_authority is not set"),
        };
...
impl<'a, 'b> SetInitializePoolAuthorityCpiBuilder<'a, 'b> {
    ...
    pub fn new_initialize_pool_authority(
        &mut self,
        new_initialize_pool_authority: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
