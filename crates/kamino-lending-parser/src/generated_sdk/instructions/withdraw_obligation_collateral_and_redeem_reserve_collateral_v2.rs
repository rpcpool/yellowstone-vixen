...
impl WithdrawObligationCollateralAndRedeemReserveCollateralV2 {
  pub fn instruction(&self, args: WithdrawObligationCollateralAndRedeemReserveCollateralV2InstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: WithdrawObligationCollateralAndRedeemReserveCollateralV2InstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&WithdrawObligationCollateralAndRedeemReserveCollateralV2InstructionData::new()).unwrap();
...
pub struct WithdrawObligationCollateralAndRedeemReserveCollateralV2CpiBuilder<'a, 'b> {
  instruction: Box<WithdrawObligationCollateralAndRedeemReserveCollateralV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WithdrawObligationCollateralAndRedeemReserveCollateralV2CpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(WithdrawObligationCollateralAndRedeemReserveCollateralV2CpiBuilderInstruction {
      __program: program,
              owner: None,
              obligation: None,
              lending_market: None,
