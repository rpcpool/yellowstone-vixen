...
impl RepayObligationLiquidity {
  pub fn instruction(&self, args: RepayObligationLiquidityInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: RepayObligationLiquidityInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&RepayObligationLiquidityInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct RepayObligationLiquidityInstructionData {
            discriminator: [u8; 8],
            }

impl RepayObligationLiquidityInstructionData {
  pub fn new() -> Self {
    Self {
...
impl Default for RepayObligationLiquidityInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct RepayObligationLiquidityInstructionArgs {
                  pub liquidity_amount: u64,
      }


/// Instruction builder for `RepayObligationLiquidity`.
///
/// ### Accounts:
///
                ///   0. `[signer]` owner
...
pub struct RepayObligationLiquidityBuilder {
...
impl RepayObligationLiquidityBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = RepayObligationLiquidity {
          ...
          let args = RepayObligationLiquidityInstructionArgs {
  ...
  /// `repay_obligation_liquidity` CPI accounts.
  pub struct RepayObligationLiquidityCpiAccounts<'a, 'b> {
...
/// `repay_obligation_liquidity` CPI instruction.
pub struct RepayObligationLiquidityCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: RepayObligationLiquidityInstructionArgs,
  }

impl<'a, 'b> RepayObligationLiquidityCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: RepayObligationLiquidityCpiAccounts<'a, 'b>,
...
/// Instruction builder for `RepayObligationLiquidity` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` owner
...
#[derive(Clone, Debug)]
pub struct RepayObligationLiquidityCpiBuilder<'a, 'b> {
  instruction: Box<RepayObligationLiquidityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RepayObligationLiquidityCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(RepayObligationLiquidityCpiBuilderInstruction {
      __program: program,
              owner: None,
              obligation: None,
              lending_market: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = RepayObligationLiquidityCpi {
...
#[derive(Clone, Debug)]
struct RepayObligationLiquidityCpiBuilderInstruction<'a, 'b> {
