...
impl DepositReserveLiquidity {
  pub fn instruction(&self, args: DepositReserveLiquidityInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DepositReserveLiquidityInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&DepositReserveLiquidityInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct DepositReserveLiquidityInstructionData {
            discriminator: [u8; 8],
            }

impl DepositReserveLiquidityInstructionData {
  pub fn new() -> Self {
    Self {
...
impl Default for DepositReserveLiquidityInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct DepositReserveLiquidityInstructionArgs {
                  pub liquidity_amount: u64,
      }


/// Instruction builder for `DepositReserveLiquidity`.
///
/// ### Accounts:
///
                ///   0. `[signer]` owner
          ...
          ///   4. `[]` reserve_liquidity_mint
                ...
                ///   6. `[writable]` reserve_collateral_mint
                ///   7. `[writable]` user_source_liquidity
                ///   8. `[writable]` user_destination_collateral
...
pub struct DepositReserveLiquidityBuilder {
...
impl DepositReserveLiquidityBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = DepositReserveLiquidity {
          ...
          let args = DepositReserveLiquidityInstructionArgs {
  ...
  /// `deposit_reserve_liquidity` CPI accounts.
  pub struct DepositReserveLiquidityCpiAccounts<'a, 'b> {
...
/// `deposit_reserve_liquidity` CPI instruction.
pub struct DepositReserveLiquidityCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: DepositReserveLiquidityInstructionArgs,
  }

impl<'a, 'b> DepositReserveLiquidityCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: DepositReserveLiquidityCpiAccounts<'a, 'b>,
...
/// Instruction builder for `DepositReserveLiquidity` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` owner
...
#[derive(Clone, Debug)]
pub struct DepositReserveLiquidityCpiBuilder<'a, 'b> {
  instruction: Box<DepositReserveLiquidityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DepositReserveLiquidityCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(DepositReserveLiquidityCpiBuilderInstruction {
      __program: program,
              owner: None,
              reserve: None,
              lending_market: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = DepositReserveLiquidityCpi {
...
#[derive(Clone, Debug)]
struct DepositReserveLiquidityCpiBuilderInstruction<'a, 'b> {
