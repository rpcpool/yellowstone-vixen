...
mod tests {
    ...
    fn test_aggregation_event_from_balance_log() {
        let log = "Program log: after_source_balance: 1410699797, after_destination_balance: 18851684497, source_token_change: 1410699795, destination_token_change: 7482284974";
        ...
        println!("  after_destination_balance: {}", event.after_destination_balance);
        println!("  source_token_change: {}", event.source_token_change);
        println!("  destination_token_change: {}", event.destination_token_change);
    }
    ...
    fn test_aggregation_event_from_logs_collection() {
        let logs = vec![
            ...
            "Program log: after_source_balance: 1410699797, after_destination_balance: 18851684497, source_token_change: 1410699795, destination_token_change: 7482284974".to_string(),
    ...
    fn test_aggregation_event_incomplete_balance_log() {
        let incomplete_log = "Program log: after_source_balance: 1410699797, after_destination_balance: 18851684497";
    ...
    fn test_aggregation_event_no_program_log_prefix() {
        let log_without_prefix = "after_source_balance: 1410699797, after_destination_balance: 18851684497, source_token_change: 1410699795, destination_token_change: 7482284974";
    ...
    fn test_aggregation_event_from_logs_all() {
        let logs = vec![
            ...
            "Program log: after_source_balance: 1410699797, after_destination_balance: 18851684497, source_token_change: 1410699795, destination_token_change: 7482284974".to_string(),
            "Another log message".to_string(),
            "Program log: after_source_balance: 2500000000, after_destination_balance: 1500000000, source_token_change: 100000000, destination_token_change: 50000000".to_string(),
            "Invalid log".to_string(),
            "Program log: after_source_balance: 999999999, after_destination_balance: 111111111, source_token_change: 888888888, destination_token_change: 222222222".to_string(),
            "Final log message".to_string(),
        ];

        let aggregation_events = AggregationEvent::from_logs_all(&logs);

        assert_eq!(aggregation_events.len(), 3, "Should find 3 AggregationEvents in logs");
