...
///   4. `[writable, optional]` sa_authority (default to `HV1KXxWFaSeriyFvXyx48FqG9BoFbfinB8njCJonqP7K`)
...
impl ClaimBuilder {
    ...
    /// `[optional account, default to 'HV1KXxWFaSeriyFvXyx48FqG9BoFbfinB8njCJonqP7K']`
    #[inline(always)]
