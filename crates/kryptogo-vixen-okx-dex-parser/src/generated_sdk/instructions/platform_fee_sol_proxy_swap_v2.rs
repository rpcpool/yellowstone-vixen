...
pub const PLATFORM_FEE_SOL_PROXY_SWAP_V2_DISCRIMINATOR: [u8; 8] =
...
impl PlatformFeeSolProxySwapV2 {
    pub fn instruction(
        &self,
        args: PlatformFeeSolProxySwapV2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&PlatformFeeSolProxySwapV2InstructionData::new()).unwrap();
...
pub struct PlatformFeeSolProxySwapV2InstructionData {
    discriminator: [u8; 8],
}

impl PlatformFeeSolProxySwapV2InstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for PlatformFeeSolProxySwapV2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
/// Instruction builder for `PlatformFeeSolProxySwapV2`.
///
/// ### Accounts:
///
...
pub struct PlatformFeeSolProxySwapV2Builder {
...
impl PlatformFeeSolProxySwapV2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = PlatformFeeSolProxySwapV2 {
        ...
        let args = PlatformFeeSolProxySwapV2InstructionArgs {
...
/// `platform_fee_sol_proxy_swap_v2` CPI accounts.
pub struct PlatformFeeSolProxySwapV2CpiAccounts<'a, 'b> {
...
/// `platform_fee_sol_proxy_swap_v2` CPI instruction.
pub struct PlatformFeeSolProxySwapV2Cpi<'a, 'b> {
    ...
    pub __args: PlatformFeeSolProxySwapV2InstructionArgs,
}

impl<'a, 'b> PlatformFeeSolProxySwapV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: PlatformFeeSolProxySwapV2CpiAccounts<'a, 'b>,
        args: PlatformFeeSolProxySwapV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `PlatformFeeSolProxySwapV2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
#[derive(Clone, Debug)]
pub struct PlatformFeeSolProxySwapV2CpiBuilder<'a, 'b> {
    instruction: Box<PlatformFeeSolProxySwapV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PlatformFeeSolProxySwapV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(PlatformFeeSolProxySwapV2CpiBuilderInstruction {
            __program: program,
            payer: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = PlatformFeeSolProxySwapV2Cpi {
...
#[derive(Clone, Debug)]
struct PlatformFeeSolProxySwapV2CpiBuilderInstruction<'a, 'b> {
