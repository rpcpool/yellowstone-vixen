...
pub const SWAP_V3_DISCRIMINATOR: [u8; 8] = [240, 224, 38, 33, 176, 31, 241, 175];
...
impl SwapV3 {
    pub fn instruction(&self, args: SwapV3InstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&SwapV3InstructionData::new()).unwrap();
...
pub struct SwapV3InstructionData {
    discriminator: [u8; 8],
}

impl SwapV3InstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for SwapV3InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
/// Instruction builder for `SwapV3`.
///
/// ### Accounts:
///
...
impl SwapV3Builder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = SwapV3InstructionArgs {
...
/// `swap_v3` CPI accounts.
pub struct SwapV3CpiAccounts<'a, 'b> {
...
/// `swap_v3` CPI instruction.
pub struct SwapV3Cpi<'a, 'b> {
    ...
    pub __args: SwapV3InstructionArgs,
}

impl<'a, 'b> SwapV3Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SwapV3CpiAccounts<'a, 'b>,
        args: SwapV3InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SwapV3` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
#[derive(Clone, Debug)]
pub struct SwapV3CpiBuilder<'a, 'b> {
    instruction: Box<SwapV3CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SwapV3CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SwapV3CpiBuilderInstruction {
            __program: program,
            payer: None,
...
#[derive(Clone, Debug)]
struct SwapV3CpiBuilderInstruction<'a, 'b> {
