...
pub fn fetch_all_user_swap_balances_state(
    ...
    let mut decoded_accounts: Vec<crate::shared::DecodedAccount<UserSwapBalancesState>> =
        Vec::new();
    for i in 0..addresses.len() {
        ...
        let data = UserSwapBalancesState::from_bytes(&account.data)?;
...
pub fn fetch_all_maybe_user_swap_balances_state(
    ...
    let accounts = rpc
        .get_multiple_accounts(addresses)
        .map_err(|e| std::io::Error::new(std::io::ErrorKind::Other, e.to_string()))?;
    let mut decoded_accounts: Vec<crate::shared::MaybeAccount<UserSwapBalancesState>> = Vec::new();
    for i in 0..addresses.len() {
        let address = addresses[i];
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountDeserialize for UserSwapBalancesState {
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountSerialize for UserSwapBalancesState {}
...
impl anchor_lang::IdlBuild for UserSwapBalancesState {}

#[cfg(feature = "anchor-idl-build")]
impl anchor_lang::Discriminator for UserSwapBalancesState {
