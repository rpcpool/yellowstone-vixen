...
/// PumpFees Program State
#[allow(clippy::large_enum_variant)]
#[derive(Debug)]
#[cfg_attr(feature = "tracing", derive(strum_macros::Display))]
pub enum PumpFeesProgramState {
    FeeConfig(FeeConfig),
}

impl PumpFeesProgramState {
    pub fn try_unpack(data_bytes: &[u8]) -> yellowstone_vixen_core::ParseResult<Self> {
        let acc_discriminator: [u8; 8] = data_bytes[0..8].try_into()?;
        let acc = match acc_discriminator {
            [143, 52, 146, 187, 219, 123, 76, 155] => Ok(PumpFeesProgramState::FeeConfig(
...
impl yellowstone_vixen_core::Parser for AccountParser {
    ...
    type Output = PumpFeesProgramState;

    fn id(&self) -> std::borrow::Cow<'static, str> {
        "pump_fees::AccountParser".into()
    }
    ...
    async fn parse(
        ...
        let res = PumpFeesProgramState::try_unpack(&inner.data);
...
// #[cfg(feature = "proto")]
mod proto_parser {
    use super::{AccountParser, PumpFeesProgramState};
    ...
    impl IntoProto<proto_def::ProgramState> for PumpFeesProgramState {
        fn into_proto(self) -> proto_def::ProgramState {
            let state_oneof = match self {
                PumpFeesProgramState::FeeConfig(data) => {
