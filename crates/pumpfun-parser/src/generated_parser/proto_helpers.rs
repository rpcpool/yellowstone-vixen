        ...
        fn into_proto(self) -> proto_def::TradeEvent {
            match self {
                TradeEvent::V1(v1_event) => proto_def::TradeEvent {
                    ...
                    fee_recipient: v1_event.fee_recipient.to_string(),
                    fee_basis_points: v1_event.fee_basis_points,
                    fee: v1_event.fee,
                    creator: v1_event.creator.to_string(),
                    creator_fee_basis_points: v1_event.creator_fee_basis_points,
                    creator_fee: v1_event.creator_fee,
                },
                TradeEvent::V2(v2_event) => proto_def::TradeEvent {
                    ...
                    fee_recipient: v2_event.fee_recipient.to_string(),
                    fee_basis_points: v2_event.fee_basis_points,
                    fee: v2_event.fee,
                    creator: v2_event.creator.to_string(),
                    creator_fee_basis_points: v2_event.creator_fee_basis_points,
                    creator_fee: v2_event.creator_fee,
                },
            }
        }
    }
