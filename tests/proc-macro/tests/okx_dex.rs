...
async fn parse_swap_v3_ix() {
    ...
    let expected = dex_solana::instruction::SwapV3 {
        accounts: dex_solana::instruction::SwapV3Accounts {
            ...
            sa_authority: Some(p("HV1KXxWFaSeriyFvXyx48FqG9BoFbfinB8njCJonqP7K")),
            source_token_sa: Some(p("D5wjgMadAHGstes5ZTCuw8XnGhxiQdsiMo3D44bei3tu")),
            destination_token_sa: Some(p("2rikd7tzPbmowhUJzPNVtX7fuUGcnBa8jqJnx6HbtHeE")),
            source_token_program: Some(p("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA")),
            destination_token_program: Some(p("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA")),
            associated_token_program: Some(p("ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL")),
            system_program: Some(p("11111111111111111111111111111111")),
